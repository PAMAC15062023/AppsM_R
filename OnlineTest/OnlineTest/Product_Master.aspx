<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineTestMasterPage.Master" AutoEventWireup="true" CodeBehind="Product_Master.aspx.cs" Inherits="OnlineTest.Product_Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <table style="width: 1170px;">
        ...
        <tr>
            <td class="TableHeader" colspan="7" id="header1" runat="server" style="font-size: medium">Add Product</td>
        </tr>
      <%--  <tr>
    ...
    <asp:Panel ID="Mainpanel" runat="server">
        <table>
            ...
            <tr>
                ...
                <td class="TableTitle"><strong><span style="font-size: small">Product Name:</span></strong></td>
                <td class="TableGrid">
                    <asp:TextBox ID="TxtProdName" runat="server" Width="348px"></asp:TextBox>
    ...
    <asp:GridView ID="GrdProduct" runat="server" AutoGenerateColumns="False" CssClass="mGrid" Width="351px" BackColor="White" BorderColor="#999999"
        BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" DataKeyNames="product_id">       
