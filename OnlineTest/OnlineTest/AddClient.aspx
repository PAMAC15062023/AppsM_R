<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineTestMasterPage.Master" AutoEventWireup="true" CodeBehind="AddClient.aspx.cs" Inherits="OnlineTest.AddClient" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Mainpanel" runat="server">
        <table>
            ...
            <tr>
                ...
                <td class="TableTitle"><strong><span style="font-size: small">Client Name:</span></strong></td>
                <td class="TableGrid">
                    <asp:TextBox ID="TxtClientName" runat="server" Width="348px"></asp:TextBox>
    ...
    <asp:GridView ID="GrdClient" runat="server" AutoGenerateColumns="False" CssClass="mGrid" Width="351px" BackColor="White" BorderColor="#999999"
        BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" DataKeyNames="ClientID">       
