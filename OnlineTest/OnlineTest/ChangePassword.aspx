<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineTestMasterPage.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="OnlineTest.ChangePassword" %>
        ...
        <tr style="font-size: 8pt">
            <td class="TableTitle" colspan="8" rowspan="1" style="height: 37px">
                ...
                &nbsp; <asp:Button ID="btnLogin" runat="server" Font-Bold="True" OnClick="btnLogin_Click"
                    Text="Login Again"  BorderWidth="1px" />&nbsp;
                    <asp:LinkButton ID="lnkclear" runat="server" Text="Clear" OnClick="lnkclear_Click" 
                    ></asp:LinkButton>
                    </td>
        </tr>
        <tr>
