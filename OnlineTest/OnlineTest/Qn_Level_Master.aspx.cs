...
{
    public partial class Qn_Level_Master : System.Web.UI.Page
    {
        ...
        protected void LevelGrid()
        {
            ...
            sqlCom.CommandText = "Qn_LevelMaster_Grid";
        ...
        protected void SaveandUpdateProductDetils()
        {
            ...
            if (TxtLevel.Text == "")
            {
                msg = msg + "please enter the level Name ";
            }
            ...
            try
            {
                if (sqlCon.State == ConnectionState.Closed)
                {
                    ...
                    sqlCom.CommandText = "Qn_Level_Master_SP";
                    sqlCom.CommandTimeout = 0;
                    ...
                    Level.SqlDbType = SqlDbType.VarChar;
                    Level.Value = TxtLevel.Text.ToString();
                    Level.ParameterName = "@Level_name";
                    sqlCom.Parameters.Add(Level);
                    ...
                    if (SqlRow > 0)
                    {
                        lblMsgXls.Text = "Level Added Suessfully!!";
                        ClearData();
                        LevelGrid();
                    }
                    else
        ...
        protected void btn_Edit_Click1(object sender, EventArgs e)
        {
            ...
            hdnID = GrdLevel.DataKeys[gr.RowIndex]["ID"].ToString();

            Label lblLevelName = (Label)gr.FindControl("lblLevelName");
            TxtLevel.Text = lblLevelName.Text.Trim();
