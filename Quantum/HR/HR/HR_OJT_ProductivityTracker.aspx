<%@ Page Language="C#" MasterPageFile="~/HR/HR/HRMasterPage.master" AutoEventWireup="true" CodeFile="HR_OJT_ProductivityTracker.aspx.cs" Inherits="HR_HR_HR_OJT_ProductivityTracker" Title="Daily Updation Productivity Tracker" StylesheetTheme="SkinFile" %>
  ...
  <fieldset ><legend class="FormHeading">Daily Updation Performance / Productivity Tracker</legend>  
      <table width="100%" >
          ...
          <tr>
              <td class="reportTitleIncome">
                  PAMACian Code</td>
              <td class="Info" style="width: 98px">
          ...
          <tr >
              <td align="right" class="Info" colspan="4">
                  &nbsp;
                  <asp:Button ID="btnshow" runat="server" OnClick="btnshow_Click" SkinID="btn" Text="Search" ValidationGroup="ValDate" Width="123px" />&nbsp;
                  <asp:Button ID="Btnchk" runat="server" OnClick="Btnchk_Click" SkinID="btn" Text="Check Status" />
                  &nbsp; &nbsp;<asp:Button ID="Date" runat="server" Text="Date wise Updation" OnClick="Date_Click" SkinID="btn" Width="147px" Enabled="False" />
                  &nbsp; &nbsp;<asp:Button ID="BtnPreviousday" runat="server" OnClick="BtnPreviousday_Click" SkinID="btn"
                      Text="Previous Day" Width="123px" /></td>
          </tr>
          <tr>
          </tr>
          <tr>
          ...
          <asp:BoundField DataField="DOJ" HeaderText="DOJ" HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy}">
              ...
              <asp:TemplateField HeaderText="Edit"> 
                ...
                <asp:TemplateField HeaderText="Reason For Minimum Productivity">
                  ...
                  <asp:Button ID="btnSave" runat="server" Font-Bold="True" Text="Save" OnClick="btnSave_Click" ValidationGroup="VLD" />&nbsp;
