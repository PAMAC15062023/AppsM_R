<%@ Page Language="C#" MasterPageFile="~/HR/HR/HRMasterPage.master" AutoEventWireup="true" CodeFile="HR_TrainingMandaysTracker.aspx.cs" Inherits="HR_HR_HR_TrainingMandaysTracker" Title="Training Mandays Tracker" StylesheetTheme="SkinFile" Theme="SkinFile" %>
...
//            alert(arguments.Value);
  ...
  <fieldset ><legend class="FormHeading"> Training Mandays Tracker Form</legend>  
      <table width="100%" >
          <tr>
      ...
      <asp:GridView ID="GV_EMP_VEIW" Width="100%" runat="server" SkinID="gridviewNoSort" AutoGenerateColumns="False" OnPageIndexChanging="GV_EMP_VEIW_PageIndexChanging" AllowPaging="True" PageSize="20" OnRowCommand="GV_EMP_VEIW_RowCommand" >
          ...
          <asp:BoundField DataField="DOJ" HeaderText="DOJ" HtmlEncode="false" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="left"/>
              ...
              <asp:TemplateField HeaderText="Date Of Training">
                    <ItemTemplate>
                        <asp:TextBox ID="txtDateTrain" SkinID="txtSkin" Width="60px" runat="server"></asp:TextBox>[dd/mm/yyyy]
                    </ItemTemplate>
              </asp:TemplateField>
                <asp:TemplateField HeaderText="Topic">
                    <ItemTemplate>
                        <asp:TextBox ID="txtTopic" SkinID="txtSkin" Width="60px" runat="server"></asp:TextBox>
                    </ItemTemplate>
              </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Venue">
                    <ItemTemplate>
                        <asp:TextBox ID="txtVenue" SkinID="txtSkin" Width="60px" runat="server"></asp:TextBox>
                    </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField HeaderText="Duration(Hrs.)">
                    <ItemTemplate>
                        <asp:TextBox ID="txtDura" SkinID="txtSkin" Width="60px" runat="server"></asp:TextBox>
                    </ItemTemplate>
              </asp:TemplateField>
               <asp:TemplateField HeaderText="Evaluation">
                    <ItemTemplate>
                        <asp:TextBox ID="txtEva" SkinID="txtSkin" Width="60px" runat="server"></asp:TextBox>
                    </ItemTemplate>
              </asp:TemplateField>
