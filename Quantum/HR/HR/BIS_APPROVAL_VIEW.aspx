...
//            alert(arguments.Value);
  ...
  <fieldset><legend class="FormHeading" style="color: #330000">BIS-APPROVAL-VIEW</legend>  
  <table width="100%" >
      <tr>
          <td>
          </td>
          ...
          <tr>
              ...
              <td style="width: 1px">
                ...
                <td align="right">
                  ...
                  <asp:Label ID="lblCentre" runat="server" Text="Hub" Visible="False"></asp:Label>
                  </td>
              <td style="width: 11px">
                ...
                <td align="right">
                  ...
                  <asp:Label ID="lblSubcentre" runat="server" Text="DD Payble Location" Width="84px" Visible="False"></asp:Label>
                  </td>
              <td align="right">
      ...
      <asp:GridView ID="GV_EMP_VEIW" Width="100%" runat="server" SkinID="grdMain" PageSize="20" AutoGenerateColumns="False" OnRowDataBound="GV_EMP_VEIW_RowDataBound" OnPageIndexChanging="GV_EMP_VEIW_PageIndexChanging" AllowPaging="True" OnRowCommand="GV_EMP_VEIW_RowCommand">
          <Columns>
