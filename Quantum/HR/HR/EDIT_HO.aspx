...
//            alert(arguments.Value);
  ...
  <fieldset><legend class="FormHeading" style="color: #330000">HO Edit Attendance </legend>   
      <table width="100%">
            <tr>
                <td colspan="8">
          ...
          <tr>
              ...
              <td style="width: 211px">
                  <asp:ImageButton ID="ImageButton1" runat="server" BackColor="#FFFFC0" Height="25px"
                      ImageUrl="~/Images/55.jpeg" OnClick="ImageButton1_Click"
                      Width="100px" /></td>
              <td>
                  <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click" SkinID="btn" Text="Show" ValidationGroup="Valgrp" Visible="False" /></td>
          </tr>
          <tr>
              <td colspan="7">
          ...
          <tr>
              ...
              <td style="width: 211px">
                              <asp:ImageButton ID="imgbtnsave" runat="server" Height="25px" ImageUrl="~/Images/Sub.bmp"
                                  OnClick="ImageButton2_Click"  ValidationGroup="Valgrp" Width="100px" /></td>
              <td>
              </td>
          </tr>
          <tr>
          ...
          <tr>
              <td align="center" colspan="7">
                  ...
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                  <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" ValidationGroup="Valgrp" Visible="False" />
                  &nbsp; &nbsp; &nbsp;
              </td>
          </tr>
          <tr>
              <td align="left" colspan="7">
                ...
                <asp:SqlDataSource ID="sdsSubCentre" runat="server" ProviderName="System.Data.OleDb">
                  ...
                  <asp:SqlDataSource ID="sdsCentre" runat="server" 
                      ProviderName="System.Data.OleDb" SelectCommand="select  centre_id,centre_name from centre_master ">
