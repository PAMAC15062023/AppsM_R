      ...
      <table style="width: 941px">
          ...
          <tr>
              ...
              <td class="Info" style="width: 100px">
                  <asp:Label ID="lblempcode" runat="server" Text="Label" Width="150px"></asp:Label></td>
              <td class="reportTitleIncome" style="width: 100px">
                  Case Assign</td>
              <td class="Info" style="width: 100px">
          ...
          <tr>
              <td class="reportTitleIncome" style="width: 100px">
                  Employee Name</td>
              <td class="Info" style="width: 100px">
                  <asp:Label ID="lblempname" runat="server" Text="Label" Width="150px"></asp:Label></td>
              <td class="reportTitleIncome" style="width: 100px">
                  Case Complete</td>
              <td class="Info" style="width: 100px">
          ...
          <tr>
              <td class="reportTitleIncome" style="width: 100px">
                  InOut Time</td>
              <td class="Info" style="width: 100px">
                  <asp:DropDownList ID="ddlInOut" runat="server" SkinID="ddlSkin" Width="150px">
                      <asp:ListItem>NA</asp:ListItem>
          ...
          <tr>
              ...
              <td class="reportTitleIncome" style="width: 100px">
                  Induction Date</td>
              <td class="Info" style="width: 100px">
                  <asp:Label ID="lblindndate" runat="server" Text="Label" Width="150px"></asp:Label></td>
              <td style="width: 100px">
              </td>
              <td style="width: 100px">
              </td>
