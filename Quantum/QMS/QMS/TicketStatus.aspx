<%@ Page Language="C#" MasterPageFile="~/QMS/QMS/masterpage.master" AutoEventWireup="true" CodeFile="TicketStatus.aspx.cs" Inherits="QMS_QMS_TicketStatus" Title="Untitled Page"  Theme="SkinFile"%>
...
<table style="width: 700" border="2PX">
    <tr>
        <td colspan="4">
    ...
    <tr>
        ...
        <td class="tta" colspan="4"  style="width: 900px; background-color:ActiveBorder; border-color:Navy">
          <span style="font-size:20pt">Ticket Detail Info</span>  </td>
    </tr>
    <tr>
        ...
        <td style="width: 120px;" class="reportTitleIncome">
                            <strong> <span style="font-size: 12pt;">Ticket Raise Date</span></strong>
         </td>
    ...
    <tr>
        <td class="reportTitleIncome" style="width: 120px;">
             <strong> <span style="font-size: 12pt;">Ticket Raise By</span></strong>
           </td>
        <td class="Info" style="width: 120px;">
   ...
   <%-- <tr>
    ...
    <tr>
        <td class="reportTitleIncome" style="width: 120px">
               ...
               <strong> <span style="font-size: 12pt;">Problem Description</span></strong>
            </td>
        <td class="Info" colspan="3" style="width: 120px">
    ...
    <tr>
    <td class="tta" colspan="4"  style="width: 900px; background-color:ActiveBorder; border-color:Navy">
          <span style="font-size:20pt">Ticket Status Updated</span>  </td>
    ...
    <tr>
        <td class="reportTitleIncome" style="width: 120px">
             <strong> <span style="font-size: 12pt;">Update Remark</span></strong>
        </td>
        <td class="Info" colspan="3" style="width: 120px">
