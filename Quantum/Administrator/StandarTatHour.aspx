...
<fieldset><legend class="FormHeading">Standard Tat Hour</legend>
    ...
    <table id="tblSTDTAT" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td style="width: 615px"><asp:DropDownList ID="ddlActivity" runat="server" SkinID="ddlSkin"  AutoPostBack="True" OnSelectedIndexChanged="ddlActivity_SelectedIndexChanged" Width="123px" ></asp:DropDownList></td>
        </tr>
        <tr>
            <td style="width: 132px"> Product</td>
            <td style="width: 615px"><asp:DropDownList ID="ddlProduct" runat="server" SkinID="ddlSkin"  AutoPostBack="True" OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged" Width="123px"></asp:DropDownList></td>
           
        </tr>
        <tr>
            <td style="width: 132px">Client</td>
            <td style="width: 615px"><asp:DropDownList ID="ddlClient" SkinID="ddlSkin"  runat="server" Width="123px"></asp:DropDownList></td>
