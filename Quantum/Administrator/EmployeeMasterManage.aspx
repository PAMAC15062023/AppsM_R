...
<asp:SqlDataSource ID="sdsSunCentre" runat="server" 
    ...
    <asp:SqlDataSource ID="sdsDesignation" runat="server"  ProviderName="System.Data.OleDb" SelectCommand="SELECT [DESIGNATION_ID], [DESIG_CODE], [DESIGNATION] FROM [DESIGNATION_MASTER]"></asp:SqlDataSource>
</asp:Content>
