    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">    
        ...
        <asp:Button ID="btnSave"  ValidationGroup="grpRoleMaster" SkinID="btnsaveskin" runat="server" Text="Save" OnClick="btnSave_Click" /></td>
               ...
               <tr valign="top">
                   ...
                   <td style="height: 53px">
                    <asp:SqlDataSource ID="sdsRoleOperation" runat="server"  ProviderName="System.Data.OleDb" >  
                      </asp:SqlDataSource>                  
                    <asp:SqlDataSource ID="sdsProduct" runat="server"  ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT [product_id], [PRODUCT_NAME] FROM [activity_product_vw] ORDER BY [PRODUCT_NAME]"></asp:SqlDataSource>
                   </td>
