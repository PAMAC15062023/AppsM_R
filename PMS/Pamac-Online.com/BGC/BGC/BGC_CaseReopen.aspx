<%@ Page Language="C#" MasterPageFile="~/BGC/BGC/MasterPage.master" AutoEventWireup="true" CodeFile="BGC_CaseReopen.aspx.cs" Inherits="BGC_BGC_CaseReopen" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="C1" Runat="Server">
    ...
    &nbsp; &nbsp;<asp:Button ID="btnSearch" runat="server" BackColor="#FFE0C0" BorderColor="Red" Font-Bold="True"
            Text="Search" Width="88px" ForeColor="Blue" OnClick="btnSearch_Click" />
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="btnReopen"  runat="server" BackColor="#FFE0C0" BorderColor="Red"
                ...
                Text="Reopen" Width="88px" ForeColor="Blue" OnClick="btnReopen_Click" />
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    &nbsp; &nbsp; &nbsp; &nbsp;<br />
