<%@ Page Language="C#" MasterPageFile="~/BGC/BGC/MasterPage.master" AutoEventWireup="true" CodeFile="BGC_SendToClientFinal.aspx.cs" Inherits="BGC_BGC_BGC_SendToClientFinal" Title="Untitled Page" Theme="skinfile" %>
...
<td colspan="5">
    ...
    <Columns>
        <asp:TemplateField HeaderText="Select">
            <ItemTemplate>
             ...
             <%--  add by kanchan--%>
           <%-- <asp:HyperLink ID="hlView" runat="server" Text="View Report" NavigateUrl="~/CPV/EBC/EBC_CaseStatusView.aspx">
               </asp:HyperLink>--%>
                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" >View Report</asp:LinkButton>
            </ItemTemplate>
            <HeaderTemplate>
        ...
        <asp:BoundField DataField="Verification_code"   HeaderText="Verification Code" ></asp:BoundField>
        ...
        <asp:TemplateField HeaderText="Within TAT">
           ...
           <asp:BoundField DataField="Ref_no"   HeaderText="Ref No" ></asp:BoundField>
                <asp:BoundField DataField="ErrorLog"  HeaderText="ErrorLog" ></asp:BoundField>
                   
                
                    <asp:BoundField DataField="verification_type_id"  HeaderText="Verification Type Id" ></asp:BoundField>
    ...
    <%--<input id="btnCalcTat" type="button" value="TatCalculation" onclick="funValidateSendToDate();"          
        style="border-color:#476085; border-style:solid; border-width:1px;font-family:Verdana;font-size:11px;font-weight:bold; visibility: visible;" />--%>
        </td>
    <td align="right"  id="TD1" runat="server">
    
        &nbsp;<asp:Button ID="btnSentToClient" runat="server" SkinID="btnSendSkin" OnClick="btnSentToClient_Click" OnClientClick="funValidateSendToDate();" ValidationGroup="grpSend"/>&nbsp;
    </td>
    </tr>
    </table>  
    </asp:Panel>      
