<%@ Page Language="C#" MasterPageFile="~/BGC/BGC/MasterPage.master" AutoEventWireup="true" CodeFile="BGC_Verification.aspx.cs" Inherits="BGC_BGC_BGC_Verification"  Theme="SkinFile" Title="Untitled Page" %>
...
<tr><td ></td><td style="width: 755px" >
 <asp:Table ID="tblBusiVerification" runat="server" Width="100%">
    ...
    <!--Start ErrorMessgage-->
     ...
     <asp:Panel ID="pnlLanNo" runat="server" Width="100%" Visible="true">
                                    <table id="tblLanNo" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
                                        <tr>
                                            <td class="TDWidth">
                                                <asp:Label SkinID="lblSkin" ID="lblLanNo" runat="server" Text="Ref No"></asp:Label>
                                            </td>
                                            <td style="width: 2%">
                                                :</td>
                                            <td>
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblNameofPersonContacted" runat="server" Text="Name of Respondent"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblRelationshiptoEmp" runat="server" Text="Relation with Candidate"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <asp:Panel ID="pnlTeleNo" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblNoOfYear" runat="server" Text="Period of stay"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
             ...
             <asp:Panel ID="pnlTypeOfAccomodation" runat="server" Width="100%" Visible="true">
              <table cellpadding="0" cellspacing="0" border="0" id="tblTypeOfAccomodation" style="width: 100%"
                     ...
                     <tr>
                      ...
                      <%--  <asp:TextBox ID="txtTypeOfAccomodation" runat="server" SkinID="txtSkin"></asp:TextBox>--%>
                            <asp:DropDownList ID="ddlTypeOfAccomodation" SkinID="ddlSkin" runat="server" Visible="true" >
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblResidenceType" runat="server" Text="Residence Status"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
       ...
       <%--         <asp:ListItem Text="Annexe To House" Value="Annexe To House"></asp:ListItem>
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblGapIdentified" runat="server" Text="Number family members"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblLandMark" runat="server" Text="Landmark obtained"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <asp:Panel ID="pnlMarritalStatus" runat="server" Width="100%" Visible="false">
           ...
           <asp:Panel ID="pnlApplicantAge" runat="server" Width="100%" Visible="false">
           ...
           <asp:Panel ID="pnlFamily" runat="server" Width="100%" Visible="false">          
       <table width="100%" >
               <tr>
            <td class="TDWidth">
           ...
           <asp:Panel ID="pnlTeleNo1" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            ...
            <asp:Panel ID="pnlNeighbourName" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblNeighbourFeedBack" runat="server" Text="Neighbour  Confirmation 1"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
                <asp:TextBox SkinID="txtSkin" Width="80%" ID="txtNeighbourFeedBackOn" runat="server"  TextMode="MultiLine" onkeypress="return PreventCharacterToAdd1('ctl00_C1_txtNeighbourFeedBackOn');" onkeyup="return PreventCharacterToAdd1('ctl00_C1_txtNeighbourFeedBackOn');"></asp:TextBox>
                    ...
                    <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblNeighbourFeedBack2" runat="server" Text="Neighbour  Confirmation 2"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
                <asp:TextBox SkinID="txtSkin" Width="80%" ID="txtNeighbourFeedBackOn2" runat="server"  TextMode="MultiLine" onkeypress="return PreventCharacterToAdd1('ctl00_C1_txtNeighbourFeedBackOn');" onkeyup="return PreventCharacterToAdd1('ctl00_C1_txtNeighbourFeedBackOn');"></asp:TextBox>
                </td>
                </tr>
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblRemk" runat="server" Text="Additional Comment"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <!----------Finish of RV Panels--------->
           <asp:Panel ID="pnlEmployeeECN" runat="server" Width="100%" Visible="false">
           ...
           <asp:Panel ID="pnlPeroidOfGap" runat="server" Width="100%" Visible="false">
           ...
           <asp:Panel ID="pnlReasonOfGap" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            ...
            <asp:Panel ID="pnlAddressDuringGap" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            <td class="TDWidth"  >
                ...
                <asp:Panel ID="pnlpoliceVerificationGap" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            <td class="TDWidth"  >
                ...
                <asp:Panel ID="pnlPoliceVerification" runat="server" Width="100%" Visible="false">
           ...
           <!----------End of GAP Panels--------->
            ...
            <asp:Panel ID="pnlRespondentDesignation" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            <td class="TDWidth"  >
              ...
              <asp:Panel ID="pnlOrganisationName" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            <td class="TDWidth"  >
                ...
                <asp:TextBox SkinID="txtSkin" Width="80%" ID="txtOrganisationName" runat="server" MaxLength="100" ></asp:TextBox>
                    ...
                    <asp:Panel ID="pnlEmpDates" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            ...
            <asp:Panel ID="pnlLastPositionheld" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            <td class="TDWidth"  >
                ...
                <asp:TextBox SkinID="txtSkin" Width="80%" ID="txtLastPosition" runat="server" MaxLength="100" ></asp:TextBox>
                      ...
                      <asp:Panel ID="pnlReportingManager" runat="server" Width="100%" Visible="false">
           ...
           <tr>
            <td class="TDWidth"  >
                ...
                <td>
        <%--  <asp:DropDownList SkinID="ddlSkin" ID="ddlStatus1" runat="server" DataSourceID="SdsStatus" DataTextField="STATUS_NAME" DataValueField="Case_status_id"  AutoPostBack="false">
            </asp:DropDownList>--%>
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblVerificatorName" runat="server" Text="Name of Field Executive"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
           ...
           <asp:Panel ID="pnlDatesAttended" runat="server" Width="100%" Visible="false">
           <table cellpadding="0" cellspacing="0" border="0" id="tblDatesAttented" style="width:100%" runat="server">
           
           <tr>
            <td class="TDWidth" >
                <asp:Label SkinID="lblSkin" ID="lblDatesAttended" runat="server" Text="Report Sent date"></asp:Label>
                </td><td style="width:2%">:</td>
                <td>
                <asp:TextBox SkinID="txtSkin"  ID="txtDatesdAttended" runat="server" MaxLength="50" ></asp:TextBox>
                  ...
                  <asp:Panel ID="pnlQualificationGained" runat="server" Width="100%" Visible="false">
       ...
       <%--   FOr Error log--%>
           ...
           <tr>
            <td class="TDWidth"  >
                <asp:Label SkinID="lblSkin" ID="lblAccessblity" runat="server" Text="Error log" Visible="false"></asp:Label>
                </td>
                <td style="width:2%">:</td>
                <td>
               
                    <asp:DropDownList ID="ddlErrorLog" runat="server"  AutoPostBack="true" Visible="false" OnSelectedIndexChanged="ddlErrorLog_SelectedIndexChanged"> 
                     <asp:ListItem Text="NA" Value="NA"></asp:ListItem>
                      <asp:ListItem Text="Negotiable" Value="Negotiable"></asp:ListItem>
                     <asp:ListItem Text="NonNegotiable" Value="NonNegotiable"></asp:ListItem>
                     <asp:ListItem Text="Rework" Value="Rework"></asp:ListItem>
                     </asp:DropDownList>
                     <asp:TextBox SkinID="txtSkin" Width="80%" ID="txtAccessbility" runat="server" MaxLength="100" TextMode="MultiLine" Visible="false"></asp:TextBox>
                     <br />
                            <asp:Label SkinID="lblSkin" ID="lblEM" runat="server" Visible="false" ForeColor="red" ></asp:Label>
               ...
               <asp:Panel ID="pnlUploadAttach" runat="server" Width="100%" Visible="true">
        ...
        <tr>         
            ...
            <td >
                 <asp:FileUpload ID="FileUpload5" Width="70%"  runat="server" SkinID="flup"/>
                  ...
                  <asp:Panel ID="pnlPreviousjobDetail" runat="server" Width="100%" Visible="false">
    ...
    <table cellpadding="0" cellspacing="0" border="0" id="tblSubmit" width="100%" >
      <tr>
       <td align="center">
       <asp:Button ID="btnEdit" runat="server" Text="Edit"  OnClick="btnEdit_Click" SkinID="btnEditSkin" Visible="false" />
...
<tr><td style="height: 28px"></td><td style="width: 755px; height: 28px;">
    ...
    &nbsp;
</td><td style="height: 28px"><asp:HiddenField ID="hdnTransStart" runat="server" />
