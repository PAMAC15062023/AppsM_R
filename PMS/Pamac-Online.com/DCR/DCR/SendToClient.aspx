<%@ Page Language="C#" MasterPageFile="~/DCR/DCR/DCR_MasterPage.master" AutoEventWireup="true" CodeFile="SendToClient.aspx.cs" Inherits="DCR_DCR_SendToClient" Title="Untitled Page" Theme="SkinFile"%>
...
<table style="width: 800px; height: 379px;">
    ...
    <tr>
       <td style="width: 110px; height: 1px;" class="Info" colspan="4">
           <asp:Button ID="btnSearch" runat="server" SkinID="btnSearchSkin"  ValidationGroup="grpSearch" OnClick="btnSearch_Click"/>  </td>
    </tr>
    <tr>
        ...
        <td colspan="6" style="height: 107px">
            &nbsp;<asp:GridView ID="gvSendTat" runat="server" AutoGenerateColumns="False" OnDataBound="gvSendTat_DataBound"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Verification_Type_ID" HeaderText="Verification Type" />
                    ...
                    <asp:BoundField DataField="Cust_Fullname" HeaderText="Applicant Name" />
                    <asp:BoundField DataField="Initiation_Date" HeaderText="Initiation Date" />
                    <asp:BoundField DataField="Upload_Date" DataFormatString="{0:dd/MM/yyyy hh:mm tt}" HeaderText="Upload Date"
                        HtmlEncode="False" />
            ...
            <table id="Table1" runat="server" width="100%">
                <tr>
                    ...
                    <td id="TD1" runat="server" align="right">
                        &nbsp;<asp:Button ID="btnSentToClient" runat="server" ValidationGroup="grpSend"
                         OnClick="btnSentToClient_Click" SkinID="btnSendSkin" />&nbsp;
                    </td>
                </tr>
            </table>
        </asp:Panel>      
