<%@ Page Language="C#" MasterPageFile="~/DCR/DCR/DCR_MasterPage.master" AutoEventWireup="true" CodeFile="DCR_Import.aspx.cs" Inherits="DCR_DCR_DCR_Import" Title="Untitled Page" StylesheetTheme="SkinFile" %>
    ...
    <tr >
        ...
        <td style="width: 225px; height: 6px;" class="Info">
            <asp:DropDownList ID="ddlCaseType" runat="server" SkinID="ddlSkin" Width="100px">
                ...
                <asp:ListItem Value="2">Online Cases</asp:ListItem>
            </asp:DropDownList>
            &nbsp;&nbsp;
        </td>
