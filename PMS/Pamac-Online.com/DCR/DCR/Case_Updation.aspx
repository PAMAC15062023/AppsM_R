<%@ Page Language="C#" MasterPageFile="~/DCR/DCR/DCR_MasterPage.master" AutoEventWireup="true" CodeFile="Case_Updation.aspx.cs" Inherits="DCR_DCR_Case_Updation" Title="Untitled Page" Theme="SkinFile"%>
        ...
        <tr>
            <td colspan="4">
                <div style="overflow: scroll; width: 880px; height: 300px">
                    <asp:GridView ID="grvCaseEntry" runat="server" SkinID="gridviewSkin" AllowSorting="true" AutoGenerateColumns="false"
                         OnRowCommand="grvCaseEntry_RowCommand" OnRowEditing="grvCaseEntry_RowEditing" OnSorting="grvCaseEntry_Sorting">  
                        <Columns>
                           <asp:TemplateField HeaderText="EDIT">
                           <ItemTemplate>
                                <asp:LinkButton ID="lnkCaseEntry" runat="server" CommandArgument='<%#Eval("Case_ID")%>'
                           ...
                           <asp:BoundField DataField="CUST_ADD_LINE_1" HeaderText="Customer Address"  SortExpression="CUST_ADD_LINE_1"/>
                           ...
                           <asp:BoundField DataField="ReceivedDate" HeaderText="Case Received Date"  SortExpression="ReceivedDate"/>
                           <asp:BoundField DataField="ReceivedTime" HeaderText="Case Received Time"  SortExpression="ReceivedTime"/>
