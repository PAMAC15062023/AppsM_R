    ...
    <tr>
         ...
         <PagerSettings Position="Top" />
                ...
                <asp:SqlDataSource ID="sdsTC" runat="server" 
                    ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT Emp_id,FULLNAME FROM EMPLOYEE_MASTER WHERE department_id=10140  and (DESIGNATION_ID = '8') AND (DOL IS NULL OR  DOL=' ') ORDER BY FULLNAME&#13;&#10;">
                </asp:SqlDataSource>
