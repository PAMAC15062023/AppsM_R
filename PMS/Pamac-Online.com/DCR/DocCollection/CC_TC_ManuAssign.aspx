<%@ Page Language="C#" MasterPageFile="~/DCR/DocCollection/CC_MasterPage.master" AutoEventWireup="true" CodeFile="~/DCR/DocCollection/CC_TC_ManuAssign.aspx.cs" Inherits="CPV_CC_CC_TC_ManuAssign" Theme="SkinFile" %>
 ...
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <asp:Button ID="Button1" runat="server" Text="Assign Cases" ValidationGroup="vgrpFE" OnClick="btnAssign_Click" Font-Bold="True" /></fieldset>
     ...
     SelectCommand="SELECT VERIFICATION_TYPE_ID, VERIFICATION_TYPE_CODE FROM VERIFICATION_TYPE_MASTER WHERE (VERIFICATION_TYPE_ID IN (4, 3)) AND (PARENT_TYPE_CODE = 'TV')"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="sdsFE" runat="server"  ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT FULLNAME, Emp_id FROM EMPLOYEE_MASTER WHERE (DESIGNATION_ID = '8') AND (DOL IS NULL OR DOL=' ') AND department_id=10140  ORDER BY FULLNAME">
        </asp:SqlDataSource>
