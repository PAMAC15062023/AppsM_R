<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPV/CC/CC_MasterPage.master" Theme="SkinFile" CodeFile="CC_TCAutoWiseReport.aspx.cs" Inherits="CPV_CC_CC_TCAutoWiseReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="C1" Runat="Server">
<table border="0" cellpadding="0" cellspacing="0" width="99%">
<tr><td style="padding-left:10px">
<fieldset><legend class="FormHeading">TeleCaller Auto Assign Report</legend>
  <script language="javascript" src="../../popcalendar.js" type="text/javascript"></script>
        ...
        <table align="center" width="100%">
            <tr>
                ...
                <td><asp:Button ID="btnSearch" runat="server" Text="Search" SkinID="btnReportSkin" ValidationGroup="valgrp" OnClick="btnSearch_Click" /></td>
            </tr>
            <tr>
                <td colspan="7">
                    &nbsp;</td>
