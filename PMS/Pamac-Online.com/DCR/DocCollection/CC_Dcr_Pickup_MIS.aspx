<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DCR/DocCollection/CC_MasterPage.master" Theme="SkinFile" CodeFile="~/DCR/DocCollection/CC_Dcr_Pickup_MIS.aspx.cs"  Inherits="DCR_DocCollection_CC_Dcr_Pickup_MIS" %>

<asp:Content ID="Content1" ContentPlaceHolderID="C1" runat="server">
<script type="text/javascript" language="javascript"></script>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr><td style="padding-left:10px; height: 254px;">
<fieldset><legend class="FormHeading">Pick-up MIS</legend>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
