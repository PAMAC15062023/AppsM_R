<%@ Page Language="C#" MasterPageFile="~/CPV/CC/CC_MasterPage.master" AutoEventWireup="true" CodeFile="CC_SendToClient.aspx.cs" Inherits="CPV_CC_CC_SendToClient" Theme="skinFile"%>
        ...
        if(strSendDate!="" && strSendTime!="")
        {
            ...
            if(bFlag==true)     //If send date is greater than Recd date then calculate TAT hours...
            {
                ...
                var hours = Math.floor(diff / (1000 * 60 * 60)); 
                    ...
                    //alert(hours+':'+mins);
                    //gv.rows[i].cells[5].innerText=hours+':'+mins;
                    //debugger; 
                    ...
                    if(parseInt(StdTAT)>= parseInt(gv.rows[i].cells[5].innerText))
                    {
                        r.checked=true;
                    }
                    else
            ...
            {
                alert("Send Date should not be less then Recieved Date"); 
            }   
        }      
        else
        {
...
<tr><td>From Date:* </td>
<td><asp:TextBox id="txtfromdate" runat="server" ValidationGroup="grpsearch" MaxLength="10" SkinID="txtSkin"></asp:TextBox>
    <IMG id="Img1" 
...
<td>To Date:* </td>
<td><asp:TextBox id="txtToDate" runat="server" ValidationGroup="grpsearch" MaxLength="10" SkinID="txtSkin"></asp:TextBox>
    <IMG id="Img4" 
...
alt="Calendar" src="../../Images/SmallCalendar.gif" />
    ...
    <td>
        <asp:Button ID="btnSearch" runat="server" SkinID="btnSearchSkin" OnClick="btnSearch_Click" ValidationGroup="grpSearch" OnClientClick="return funValidateFromToDate()" /></td>
</tr>
    <tr>
        <td colspan="5" style="height: 14px">&nbsp;<asp:Label ID="lblMsg" ForeColor="Red" Font-Bold="True" runat="server" Visible="False" Width="616px"></asp:Label></td>
    </tr>
<tr>
<td colspan="5">
    ...
    <td><asp:TextBox id="txtSendDt" runat="server" ValidationGroup="grpSend" MaxLength="10" SkinID="txtSkin"  CssClass="textbox"></asp:TextBox>
    <IMG id="Img2" 
    onclick="popUpCalendar(this, document.all.<%=txtSendDt.ClientID%>, 'dd/mm/yyyy', 0, 0);" 
    alt="Calendar" src="../../Images/SmallCalendar.gif" />
    ...
    <td>
    <asp:TextBox id="txtSendTm" runat="server" ValidationGroup="grpSend" MaxLength="5" SkinID="txtSkin"  CssClass="textbox"></asp:TextBox>
    <asp:Label id="lblhourandminformate" runat="server" SkinID="lblSkin" Text="[hh:mm]" ></asp:Label>
    <asp:DropDownList id="ddlSendTimeType" runat="server" SkinID="ddlSkin" CssClass="combo">
...
<asp:RegularExpressionValidator ID="revSendDate" runat="server" ControlToValidate="txtSendDt" Display="None" 
    ErrorMessage="Please enter valid date format for Send Date" SetFocusOnError="True" 
    ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[0-2])[- /.](19|20|21)\d\d"  ValidationGroup="grpSend"></asp:RegularExpressionValidator>
<asp:RegularExpressionValidator ID="revSendTime" runat="server" ControlToValidate="txtSendTm" Display="None" 
    ErrorMessage="Please enter valid Time Format for Send Time" SetFocusOnError="True" 
