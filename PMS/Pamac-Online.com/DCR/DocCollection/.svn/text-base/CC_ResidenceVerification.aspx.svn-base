        <%@ Page Language="C#" MasterPageFile="~/DCR/DocCollection/CC_MasterPage.master" Theme="SkinFile" 
AutoEventWireup="true" CodeFile="~/DCR/DocCollection/CC_ResidenceVerification.aspx.cs" Inherits="CC_CC_ResidenceVerification"%>
...
<tr>
<td class="TDWidth">
    <asp:Label SkinID="lblSkin" ID="lblSupName" runat="server"  Text="Super Name"></asp:Label>
</td><td style="width:2%">:</td>
<td >
