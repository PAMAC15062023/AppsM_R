<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DCR/DocCollection/CC_MasterPage.master" Theme="SkinFile" CodeFile="~/DCR/DocCollection/Dcr_Mis_Tele_Report.aspx.cs" Inherits="DcrTeleMIS" %>
...
//}
    ...
    <td>
    <fieldset>
    <legend class="FormHeading">DCR MIS TELE Report</legend>
