<%@ Page Language="C#" MasterPageFile="~/DCR/DocCollection/CC_MasterPage.master" AutoEventWireup="true" CodeFile="~/DCR/DocCollection/CC_FeAssignmentNew.aspx.cs" Inherits="CPV_CC_FeAssignmentNew" Theme="SkinFile" %>
 ...
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
     ...
     SelectCommand="Select [VERIFICATION_TYPE_ID], [VERIFICATION_TYPE_CODE] from VERIFICATION_TYPE_MASTER &#13;&#10;               WHERE VERIFICATION_TYPE_ID IN(20,37,38,39,40,41) AND (PARENT_TYPE_CODE = 'DC')"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="sdsSearchFE" runat="server"  ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT FULLNAME, FE_ID FROM FE_VW_Dcr INNER JOIN FE_PINCODE_MAPPING ON EMP_ID=FE_ID where ([Centre_ID]=?) order by FULLNAME ">
            <SelectParameters>
