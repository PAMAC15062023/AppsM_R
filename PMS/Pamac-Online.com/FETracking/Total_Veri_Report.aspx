            ...
            <tr>
                <td colspan="6" >
                    &nbsp;<asp:SqlDataSource ID="sdsVeri" runat="server" 
                        ProviderName="System.Data.OleDb" SelectCommand="SELECT [VERIFICATION_TYPE_ID], [VERIFICATION_TYPE_CODE] FROM [VERIFICATION_TYPE_MASTER] where Parent_type_code in('vv','dv','tv')">
                    </asp:SqlDataSource>
