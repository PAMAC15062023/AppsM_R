...
<table style="width: 160px">
    ...
    <tr>
            <td class="tta" colspan="8" style="height: 19px; width: 97%;">
                <span style="font-size: 10pt">Update - Operational Call / Visit / Review Tracker&nbsp;</span></td>
        </tr>
                    ...
                    <asp:ListItem>PCRU</asp:ListItem>
                           ...
                           <tr>
                            ...
                            <td class="Info" style="width: 231px; height: 21px">
                               <asp:TextBox ID="txtVenue" runat="server" Width="123px" SkinID="txtSkin" ValidationGroup="GRPADD"  Enabled="False" Font-Bold="False"></asp:TextBox> </td>
