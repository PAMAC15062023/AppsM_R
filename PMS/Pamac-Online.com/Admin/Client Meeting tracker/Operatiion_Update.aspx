<%@ Page Language="C#" MasterPageFile="~/Admin/Client Operational Call or  Visit Tracker/MasterPage.master" Title="Untitled Page" StylesheetTheme="SkinFile" AutoEventWireup="true" CodeFile="Operatiion_Update.aspx.cs" Inherits="Admin_Operational_call_visit_Review_tracker_Operatiion_Update" %>
    ...
    <table style="width: 160px">
        ...
        <tr>
            <td class="tta" colspan="8" style="height: 19px; width: 97%;">
                <span style="font-size: 10pt">Update - Client Meeting Tracker&nbsp;</span></td>
        </tr>
                ...
                <asp:Panel ID="PnlInsert" runat="server">
                    ...
                    <table style="width: 1030px; height: 275px;">
                        ...
                        <tr>
                            ...
                            <td style="width: 173px;" class="reportTitleIncome">Visit / Call</td>
                        ...
                        <tr>
                            ...
                            <td class="reportTitleIncome" style="height: 21px; width: 173px;"></td>
                              <td class="Info" style="height: 21px; width: 231px;"></td>
                        ...
                        <tr>
                            <td style="height: 20px; width: 195px;" class="reportTitleIncome">Name Of Reviewee
                            </td>
                            <td style="height: 20px; width: 205px;" class="Info">
                                <asp:TextBox ID="txtAttendiee" runat="server" Width="123px" SkinID="txtSkin" ValidationGroup="GRPADD" Enabled="False" Font-Bold="False"></asp:TextBox></td>
                            ...
                            <td class="Info" style="width: 231px; height: 21px">
                                <asp:TextBox ID="txtVenue" runat="server" Width="123px" SkinID="txtSkin" ValidationGroup="GRPADD" Enabled="False" Font-Bold="False"></asp:TextBox>
                            </td>
            ...
            <td colspan="7">
                <asp:Panel ID="PnlView" runat="server" Width="880px">
                    <table style="width: 941px">
                        <tr>
                            <td style="width: 66px; height: 21px" class="reportTitleIncome">Centre <%--Location--%></td>
                            ...
                            <td style="width: 116px; height: 21px" class="Info">
                                <asp:DropDownList ID="DDlBranchsearch" runat="server" SkinID="ddlSkin" Width="123px" Visible="false">
                                </asp:DropDownList></td>
                            <td style="width: 70px; height: 21px"></td>
                        </tr>
                        <tr>
                            <td class="reportTitleIncome" style="width: 66px; height: 21px">Client Name</td>
                            <td class="Info" style="width: 79px; height: 21px">
                                <asp:DropDownList ID="DdlSearchClient" runat="server" SkinID="ddlSkin" Width="123px">
                                </asp:DropDownList></td>
                            <td class="reportTitleIncome" style="width: 103px; height: 21px">Vertical</td>
                        ...
                        <tr>
                            <td colspan="5" style="height: 9px">&nbsp;<asp:Button ID="BtnSearch" runat="server" SkinID="btnSearchSkin" Text="SEARCH" Width="100px" Height="24px" OnClick="BtnSearch_Click" />&nbsp;
