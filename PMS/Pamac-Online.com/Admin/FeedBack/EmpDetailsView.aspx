<%@ Page Language="C#" MasterPageFile="~/Admin/FeedBack/MasterPage.master" AutoEventWireup="true" CodeFile="EmpDetailsView.aspx.cs" Inherits="Admin_FeedBack_EmpDetailsView" Title="Untitled Page" StylesheetTheme="SkinFile"%>
...
function funValidateFromToDate()
{
  ...
  <asp:Panel ID="Panel2" runat="server" Width="907px">
        ...
        <tr>
            ...
            <td colspan="3" style="height: 25px" class="Info">
                    <%--<asp:Label ID="lbltechnicalproblm" runat="server" Text="Label" ></asp:Label>--%>
                <asp:TextBox ID="txttechnicalproblm" runat="server" Height="50px" SkinID="txtSkin" TextMode="MultiLine"
        ...
        <tr>
            <td style="width: 249px; height: 21px;" class="reportTitleIncome">
                <span style="font-size: 8pt; color: #000000; font-family: Tahoma; background-color: #e1e9ff;">
                    <strong>
                    Requirement/Remark</strong></span></td>
        ...
        <tr>
            ...
            <center><asp:Button ID="BtnActionSave" runat="server" Text="Approve" SkinID="btn" Width="100px" OnClick="BtnActionSave_Click" />
            &nbsp; &nbsp;<asp:Button ID="btnBack" runat="server" OnClick="btnBack_Click" SkinID="btnBackSkin" Text="Back" Width="100px" />
            &nbsp; &nbsp;<asp:Button ID="BtnReset12" runat="server" Text="Reset" SkinID="btn" Width="100px" /></center> </td>
            <td style="width: 100px; height: 21px;">
                &nbsp;</td>
            <td style="width: 100px; height: 21px;">
            </td>
