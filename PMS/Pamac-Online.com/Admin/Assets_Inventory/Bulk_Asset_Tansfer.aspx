<%@ Page Language="C#" MasterPageFile="~/Admin/Assets_Inventory/MasterPage.master" AutoEventWireup="true" CodeFile="Bulk_Asset_Tansfer.aspx.cs" Inherits="Admin_Assets_Inventory_Bulk_Asset_Tansfer" %>
     ...
     <table style="width: 688px;">
        <tr>
            <td class="tta" colspan="9">
                <span style="font-size: 10pt">Bulk Asset Transfer</span></td>
        </tr>
    </table>
