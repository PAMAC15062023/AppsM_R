                            ...
                            <tr>
                                <td>
                                    ...
                                    <tr><td colspan="4" class="txtBold" style="background-color:#D0D5D8; height: 16px;" align="center">Office Detail</td></tr>
                                        ...
                                        <tr>
                                            <td align="center" colspan="8" style="height: 14px">
                                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" ValidationGroup="grpValidate" SkinID="btnSubmitSkin" Font-Bold="True" Width="114px" />
                                                &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="Cancel" SkinID="btncancelskin" Font-Bold="True" Width="113px" /></td>
