...
<tr><td style="padding-left:10px;background-color:#E7F6FF"">    
...
<table id="tblExport" width="100%" cellpadding="0" cellspacing="0" border="0">
   ...
   <tr><td colspan="11"><hr />
       ...
       <asp:DropDownList ID="ddlReports" runat="server" SkinID="ddlSkin" Width="171px">
