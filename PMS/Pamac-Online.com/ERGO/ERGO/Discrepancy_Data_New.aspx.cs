...
public partial class ERGO_ERGO_Discrepancy_Data_New : System.Web.UI.Page
{
    ...
    private void GetDiscrepancy_Report()
    {
        ...
        sqlCom.CommandText = "GetDiscrepancy_Report";

        SqlParameter Discrepancy = new SqlParameter();
        Discrepancy.SqlDbType = SqlDbType.VarChar;
        Discrepancy.Value = ddlDiscrepancy.SelectedItem.Value.ToString().Trim();
