<%@ Page Language="C#" MasterPageFile="~/QueryBuilder/QueryBuilder.master" Theme="SkinFile" AutoEventWireup="true" CodeFile="MIS_Centre_VerificationType.aspx.cs" Inherits="QueryBuilder_MIS_Centre_VerificationType" %>
