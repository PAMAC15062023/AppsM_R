<%@ Page Language="C#" MasterPageFile="~/QueryBuilder/QueryBuilder.master"  Theme ="SkinFile" AutoEventWireup="true" CodeFile="MIS_Client_VerificationType.aspx.cs" Inherits="QueryBuilder_MIS_Client_VerificationType" %>
...
function funValidateFromToDate(sender, args)
{
   debugger;
    ...
    <fieldset>
        <legend class="FormHeading"><strong>Client &nbsp;MIS&nbsp; </strong></legend>
        <table style="width: 100%">
            ...
            <tr>               
                <td valign="top" colspan="7">
                 ...
                 <tr>
           <td style="height: 18px">&nbsp;<asp:Label ID="Label6" runat="server" SkinID="lblSkin" Text="Database"></asp:Label>
              <br />
               &nbsp;&nbsp;
               <asp:Label ID="Label7" runat="server" SkinID="lblSkin" Text="Centre"></asp:Label><br />
           </td>
           <td style="height: 18px">
            ...
            <td colspan="6" style="height: 18px">
             ...
             <asp:ListItem Text="RepositoryPMS" Value="RepositoryPMS"></asp:ListItem>
              ...
              <br />
                <asp:DropDownList ID="ddlCentre" runat="server" AppendDataBoundItems="True" 
            ...
            <tr >
               <td valign="top">
                ...
                <td  valign="top">
                    <asp:Label ID="Label2" runat="server" SkinID="lblSkin" Text="To Date"></asp:Label><span style="color: #ff0033;font-family:Arial;font-size:small">*</span></td>
                <td>
                :</td>
                    ...
                    <table id="tbl" runat="server" visible="false" width="100%">
                        <tr>
                            <td >
                                ...
                                Width="121px" OnClick="btnExptExcel_Click" />
                             </td>
                         </tr>
                         <tr>
                            <td >
                                 <asp:GridView ID="gvClientMIS" runat="server" SkinID="gridviewNoSort" Width="100%">
                                  </asp:GridView>
                                 </td>
                         </tr>
                    </table>
