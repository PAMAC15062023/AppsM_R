<%@ Page Language="C#" MasterPageFile="~/QueryBuilder/QueryBuilder.master" AutoEventWireup="true" CodeFile="FEPincodeMapping.aspx.cs" Inherits="Administrator_FEPincodeMapping" Theme="SkinFile"%>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        ...
        <tr>
            ...
            <td >
            <asp:TextBox ID="txtPincode" runat="server" MaxLength="500" SkinID="txtSkin" Width="563px"></asp:TextBox>
                &nbsp;&nbsp;
            </td>
            <td>
            </td>
