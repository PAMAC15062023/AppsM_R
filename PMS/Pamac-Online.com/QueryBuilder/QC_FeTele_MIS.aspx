<%@ Page Language="C#" MasterPageFile="~/QueryBuilder/QueryBuilder.master" Theme="SkinFile" AutoEventWireup="true" CodeFile="QC_FeTele_MIS.aspx.cs" Inherits="QueryBuilder_QC_FeTele_MIS" Title="Untitled Page" %>
...
<fieldset><legend class="FormHeading">QC FE and Tele Wise Dump</legend>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
...
<td style="width: 297px; height: 38px;">
    <strong>Report Type</strong><asp:DropDownList ID="ddlCenter" runat="server" 
        ...
        <asp:ListItem>TELE</asp:ListItem>
    </asp:DropDownList>&nbsp;&nbsp;&nbsp; 
    </td>
