<%@ Page Language="C#" MasterPageFile="~/QueryBuilder/QueryBuilder.master" Theme="SkinFile"  AutoEventWireup="true" CodeFile="TAT_MIS_2.aspx.cs" Inherits="QueryBuilder_TAT_MIS_2"%>
        ...
        <table style="width: 100%" id="tblTATMIS">
           ...
           <td>&nbsp;<asp:Label ID="Label8" runat="server" SkinID="lblSkin" Text="Database"></asp:Label></td>
            ...
            <tr>
                ...
                <td style="width: 644px" valign="top">
                </td>
                <td valign="top">
                </td>
            </tr>
