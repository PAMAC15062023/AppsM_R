...
<script language="javascript" type="text/javascript"src="popcalendar.js"></script>
  ...
  <fieldset ><legend class="FormHeading">Daily Updation Performance / Productivity Tracker(Earlier
      ...
      <table width="100%" >
          ...
          <tr>
              <td style="width: 92px" class="reportTitleIncome"  >
                  ...
                  <asp:DropDownList ID="ddlCluter" runat="server" AutoPostBack="True" DataSourceID="sdsCluster" DataTextField="CLUSTER_NAME" DataValueField="CLUSTER_ID" SkinID="ddlSkin" OnSelectedIndexChanged="ddlCluter_SelectedIndexChanged" OnDataBound="ddlCluter_DataBound" Width="123px" Visible="False">
                  </asp:DropDownList>
          ...
          <tr>
              <td colspan="7" style="width: 934px" >
                 ...
                 <asp:TemplateField HeaderText="Attendence">
                    <ItemTemplate>
                            <asp:DropDownList ID="ddlattendance" runat="server" SkinID="ddlSkin" AutoPostBack="True"  OnSelectedIndexChanged="ddlattendance_SelectedIndexChanged">
    ...
    &nbsp; &nbsp; &nbsp;&nbsp;
            ...
            <asp:RequiredFieldValidator ID="ReqCluster" runat="server" ErrorMessage="Please select the Cluster" ControlToValidate="ddlclustername"
        Display="None" SetFocusOnError="True" ValidationGroup="ValDate" InitialValue="0" Width="400px" >
    </asp:RequiredFieldValidator>
    
        <asp:RequiredFieldValidator ID="ReqCentre" runat="server" ErrorMessage="Please select the Centre" ControlToValidate="ddlCentre"
        Display="None" SetFocusOnError="True" ValidationGroup="ValDate" InitialValue="0">
    </asp:RequiredFieldValidator>
