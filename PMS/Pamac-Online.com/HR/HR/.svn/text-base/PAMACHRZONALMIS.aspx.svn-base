<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/HR/HR/HRMasterPage.master" Theme="SkinFile" CodeFile="PAMACHRZONALMIS.aspx.vb" Inherits="HR_HR_PAMACHRZONALMIS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<script type="text/javascript"  runat="server"></script>
<fieldset><legend class="FormHeading">PAMAC HR ZONAL MIS</legend>
