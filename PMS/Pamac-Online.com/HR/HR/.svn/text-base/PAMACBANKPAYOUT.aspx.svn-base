<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/HR/HR/HRMasterPage.master" Theme="SkinFile" CodeFile="PAMACBANKPAYOUT.aspx.vb" Inherits="HR_HR_PAMACBANKPAYOUT" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<script type="text/javascript"  runat="server"></script>
<fieldset><legend class="FormHeading">PAMAC-Bank Payout MIS</legend>
