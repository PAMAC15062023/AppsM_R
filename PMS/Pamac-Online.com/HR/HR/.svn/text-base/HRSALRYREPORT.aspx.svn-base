<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HR/HR/HRMasterPage.master" Theme="SkinFile" CodeFile="HRSALRYREPORT.aspx.cs" Inherits="HR_HR_HRSALRYREPORT" %>
<asp:Content ID="CONTENT1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<script type="text/javascript" language="javascript"></script>

<fieldset><legend class="FormHeading">PAMAC-GROSS PAYOUT MIS</legend>
...
<td><asp:Button ID="btnreport" SkinID="btn" Text="Report" runat="server" Width="104px" OnClick="btnreport_Click" /></td>
<td><asp:Button ID="Export" runat="server" Text="Export To Excel" SkinID="btnExpToExlSkin" OnClick="Export_Click" /> </td>
</tr>
