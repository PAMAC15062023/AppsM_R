            ...
            <td align="center">
                <fieldset><legend class="FormHeading"><b>Reports</b></legend>
                              <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <td class="label" align="left" style="width: 70px">
                                                             ...
                                                             <td align="left" style="width: 250px"><font color="#990000"><strong>
                                                                <asp:DropDownList ID="ddlReport" SkinID="ddlSkin" runat="server" Width="120px">
                                                                    ...
                                                                    <asp:ListItem Value="EBCRV#">Pending EBCRV#</asp:ListItem>
                                                                </asp:DropDownList>
                                                             </strong></font></td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <asp:GridView ID="GvEmpoyeePan" SkinID="gridviewSkin" runat="Server" AutoGenerateColumns="false" PageSize="20" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GvEmpoyeePan_PageIndexChanging" OnSorting="GvEmpoyeePan_Sorting">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Esic#" HeaderText="ESIC#" SortExpression="Esic#" ItemStyle-HorizontalAlign="Right" />
                                                              ...
                                                              <asp:BoundField DataField="Approval_Date#" HeaderText="Approval_Date#" SortExpression="Approval_Date#" ItemStyle-HorizontalAlign="Right" />
                                                          
                                                            <asp:BoundField DataField="Date_of_verfication#" HeaderText="Date_of_verfication#" SortExpression="Date_of_verfication#" ItemStyle-HorizontalAlign="Right" />
                                ...
                                <tr>
                                    <td>
                                        <asp:SqlDataSource ID="ClusterData" runat="server" SelectCommandType="StoredProcedure" SelectCommand="SpGetClusters"  ProviderName="System.Data.OleDb">
                                        </asp:SqlDataSource>
                                        <asp:SqlDataSource ID="PanDataSource" runat="Server" SelectCommandType="StoredProcedure" SelectCommand="SpEmployeeDetails"  ProviderName="System.Data.OleDb">
                                            <SelectParameters>
