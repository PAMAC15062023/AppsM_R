                       ...
                       <asp:BoundField DataField="Department" HeaderText="Department"  />
                        <asp:BoundField DataField="Designation" HeaderText="Designation"  />
                         <asp:BoundField DataField="Unit" HeaderText="Unit"  />
                          ...
                          <asp:TemplateField HeaderText="Outdoor" >
                             
                              <ItemTemplate>
                                  <asp:DropDownList ID="ddlOutdoor" runat="server" SkinID="ddlSkin">
                           ...
                           <asp:TemplateField HeaderText="Outdoor Remark">
                             
                              <ItemTemplate>
                                 <asp:TextBox ID="txtOutdoorRemark" runat="server" TextMode="MultiLine" Height="30px" Width="251px" ></asp:TextBox>
                              </ItemTemplate>
                          </asp:TemplateField>
