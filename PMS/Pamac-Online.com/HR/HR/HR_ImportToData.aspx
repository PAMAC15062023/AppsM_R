    ...
    <table style="width: 740px; height: 188px">
        ...
        <tr>
            <td colspan="6" style="height: 15px">
                <asp:Label ID="lblCount" runat="server" Font-Bold="True" ForeColor="#C00000"
                    SkinID="lblSkin"></asp:Label></td>
        </tr>
        <tr>
            <td colspan="6" style="height: 15px">
                <asp:Label ID="lblmsg" runat="server" Font-Bold="True" Font-Names="Arial" ForeColor="Blue"></asp:Label></td>
        </tr>
        <tr>
            <td>
            </td>
        ...
        <tr>
            <td colspan="6">
                <asp:Button ID="BtnSearch" runat="server" Height="36px" Text="Search" Width="96px" SkinID="btnUploadSkin" OnClick="Button1_Click" />
                &nbsp; &nbsp; &nbsp;&nbsp;
                <asp:Button ID="BtnUpdate" runat="server" Height="35px" OnClick="BtnUpdate_Click"
                    Text="Update" Width="92px" /></td>
        </tr>
        <tr>
            <td colspan="6">
