    ...
    <table>
        <tr>
            <td style="width: 102px; height: 15px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="DAT MIS"
        ...
        <tr>
            ...
            <td style="width: 100px; height: 16px;">
                <asp:DropDownList ID="ddlMisType" runat="server" Width="153px" AutoPostBack="True" OnSelectedIndexChanged="ddlMisType_SelectedIndexChanged" SkinID="ddlSkin">
                    ...
                    <asp:ListItem Value="Get_NewJoineeMIS1">New Joinee MIS</asp:ListItem>
                    <asp:ListItem Value="Get_PAMACianLeftMIS">PAMACian Left MIS</asp:ListItem>
                    <asp:ListItem Value="Get_PAMACianPersonalDetMIS">PAMACian Personal MIS</asp:ListItem>
                    <asp:ListItem Value="Outdoorproce">Out door MIS</asp:ListItem>
                    <%--<asp:ListItem Value="Get_PAMACianLeaveMIS">PAMACian Leave MIS</asp:ListItem>--%>
                </asp:DropDownList></td>
            <td style="width: 53px; height: 16px;">
            </td>
            <td style="width: 84px; height: 16px;">
