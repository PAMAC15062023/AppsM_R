<%@ Page Language="C#" MasterPageFile="~/HR/HR/HRMasterPage.master" AutoEventWireup="true" CodeFile="HR_ProfessionalConvertionDetails.aspx.cs" Inherits="HR_HR_HR_ProfessionalConvertionDetails" Title="Professional Convertional Details" StylesheetTheme="SkinFile" %>
...
//            alert(arguments.Value);
  ...
  <fieldset ><legend class="FormHeading">
      Profession Conversion Details</legend>  
      <table width="100%" >
          <tr>
          ...
          <tr>
              <td style="width: 81px" class="reportTitleIncome"  >
                  &nbsp;Cluster Name</td>
              ...
              <td class="reportTitleIncome" >
                  &nbsp;Centre Name</td>
                  <td style="width: 224px" class="Info" >
              ...
              <td style="width: 101px" class="reportTitleIncome" >
                  SubCenter Name</td>
          ...
          <tr>
              <td class="reportTitleIncome" style="width: 81px; height: 31px"  >
                  From Date 
                  </td>
                  <td class="Info" style="height: 31px"  >
              ...
              <td class="reportTitleIncome" style="height: 31px" >
              
                  To Date 
                  </td>
                  <td class="Info" style="width: 224px; height: 31px" >
                  ...
                  <img alt="Calendar" onclick="popUpCalendar(this, document.all.<%=txtToDate.ClientID%>, 'dd/mm/yyyy', 0, 0);"
                      src="../../Images/SmallCalendar.gif" />[dd/mm/yyyy]</td>
              <td align="right" style="width: 101px; height: 31px"   >
                  &nbsp;
                  </td>
          ...
          <tr >
              <td class="reportTitleIncome" style="width: 81px; height: 30px;" >
                  PAMACian Code</td>
              ...
              <td class="reportTitleIncome" style="height: 30px">
                  PAMACian Name</td>
              <td class="Info" style="width: 224px; height: 30px;" >
                  <asp:TextBox ID="txtEmpName" runat="server" SkinID="txtSkin"></asp:TextBox></td>
              <td align="right" colspan="2" style="text-align: center; height: 30px;">
                  &nbsp;<asp:Button ID="btnshow" runat="server" OnClick="btnshow_Click" SkinID="btn" Text="Search" ValidationGroup="ValDate" Width="60px" />&nbsp;
              </td>
          </tr>
          <tr>
          </tr>
      ...
      <asp:GridView ID="GV_EMP_VEIW" Width="103%" runat="server" SkinID="gridviewNoSort" AutoGenerateColumns="False" OnPageIndexChanging="GV_EMP_VEIW_PageIndexChanging" AllowPaging="True" PageSize="20" >
          <Columns>
           <asp:TemplateField>
                <HeaderTemplate>
          ...
          <asp:BoundField DataField="DOJ" HeaderText="DOJ" HtmlEncode="False" DataFormatString="{0:dd/MM/yyyy}">
              <ItemStyle HorizontalAlign="Left" />
               ...
               <asp:BoundField DataField="Emp_Type" HeaderText="Emp Status">
                  <ItemStyle HorizontalAlign="Left" />
              </asp:BoundField>                
                <asp:TemplateField HeaderText="Change Status">
                    <ItemTemplate>
                            <asp:DropDownList ID="ddlChangeStat" runat="server" SkinID="ddlSkin">
                ...
                <asp:TemplateField HeaderText="Basic Sal">
                    <ItemTemplate>
                        <asp:TextBox ID="txtBasic" SkinID="txtSkin" Width="50px" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>        
                <asp:TemplateField HeaderText="HRA">
                    <ItemTemplate>
                        <asp:TextBox ID="txtHRA" SkinID="txtSkin" Width="50px" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>        
                <asp:TemplateField HeaderText="SP All.">
                    <ItemTemplate>
                        <asp:TextBox ID="txtSPAllo" SkinID="txtSkin" Width="50px" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>        
                <asp:TemplateField HeaderText="Conv.">
                    <ItemTemplate>
                        <asp:TextBox ID="txtConve" SkinID="txtSkin" Width="50px" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>        
                <asp:TemplateField HeaderText="Medi Remb.">
                    <ItemTemplate>
                        <asp:TextBox ID="txtMediRemb" SkinID="txtSkin" Width="50px" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="Wash All.">
                    <ItemTemplate>
                        <asp:TextBox ID="txtWashAll" SkinID="txtSkin" Width="50px" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>  
                 <asp:TemplateField HeaderText="Gross Amt.">
                    <ItemTemplate>
                        <asp:TextBox ID="txtGrossAmt" SkinID="txtSkin" ReadOnly="true" Width="50px" runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>   
                <asp:TemplateField HeaderText="Convert Date">
                    <ItemTemplate>
                        <asp:TextBox ID="txtConvDate" SkinID="txtSkin" Width="50px" runat="server"></asp:TextBox>
                                    <%--<table cellpadding="0" cellspacing="0" style="width: 87px">
                                        <tr>
                                            <td style="width: 100px">
                                     <asp:TextBox ID="txtConvDate" runat="server" Width="50px" SkinID="txtSkin" Text='<%# (DataBinder.Eval(Container.DataItem,""))%>' ToolTip='<%# (DataBinder.Eval(Container.DataItem,"Change_StatusDate"))%>'></asp:TextBox></td>
                                            <td style="width: 100px">
                  ...
                  <asp:Button ID="btnSave" runat="server" Font-Bold="True" Text="Request Send" OnClick="btnSave_Click" />&nbsp;
