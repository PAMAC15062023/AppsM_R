<%@ Page Language="C#" MasterPageFile="~/HR/HR/HRMasterPage.master" AutoEventWireup="true" CodeFile="HO_MIS.aspx.cs" Inherits="HR_HR_HO_MIS" Title="Untitled Page" Theme="SkinFile" %>
 ...
 <script language="javascript" type="text/javascript">
    ...
    <table>
        <tr>
            <td style="width: 102px; height: 15px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="HO MIS"
                    Width="99px" SkinID="lblSkin"></asp:Label></td>
        ...
        <tr>
            <td style="width: 102px; height: 16px">
                <asp:Label ID="lblMessage" runat="server" SkinID="lblErrorMsg"  Width="98px" Font-Bold="True" ForeColor="Red"></asp:Label></td>
        ...
        <tr>
            ...
            <td style="width: 49px; height: 39px;"><img id="Img2" alt="Calendar" onclick="popUpCalendar(this, document.all.<%=txtToDate.ClientID%>, 'dd/mm/yyyy', 0, 0);"
            ...
            <td style="width: 100px; height: 16px;">
                <asp:DropDownList ID="ddlMisType" runat="server" Width="153px" AutoPostBack="True" OnSelectedIndexChanged="ddlMisType_SelectedIndexChanged" SkinID="ddlSkin">
                    ...
                    <%--<asp:ListItem Value="Get_LeftPamacian_Details">Left Pamacian MIS</asp:ListItem>--%>
                        <asp:ListItem Value="Get_LeftPamacian_Details1">Left Pamacian MIS</asp:ListItem>
                    <asp:ListItem Value="Sp_Resigned_Details">Resigned  Pamacian MIS</asp:ListItem>
                    <asp:ListItem Value="Sp_Biometrics_Export_Report">Biometrics Export Report</asp:ListItem>
                    <asp:ListItem Value="Sp_EmpRefDetails">Pamacian Reference MIS</asp:ListItem>
                    <asp:ListItem Value="Sp_EmpDetails">Pamacian BIS MIS</asp:ListItem>
                    <asp:ListItem Value="GetPMSAllData">All Pamacial Record MIS</asp:ListItem>
                </asp:DropDownList></td>
            <td style="width: 53px; height: 16px;">
            </td>
            <td style="width: 84px; height: 16px;">
        ...
        <tr>
            <td style="width: 102px">
                <asp:Button ID="btnSearch" runat="server" Text="Search" Width="96px" OnClick="btnSearch_Click" SkinID="btnSearchSkin" /></td>
            <td style="width: 100px">
                <asp:Button ID="btnExportExcel" runat="server" Text="Export To Excel" Width="121px" OnClick="btnExportExcel_Click" SkinID="btnExpToExlSkin" /></td>
            <td style="width: 53px">
                </td>
            <td style="width: 84px">
            </td>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="345px" ScrollBars="Both" Width="966px">
     <table id="tbExport" runat="server" border="0" cellpadding="0" cellspacing="0" visible="true"
                    ...
                    <tr>
                        <td>
   <asp:GridView ID="GV" runat="server" SkinID="gridviewNoSort" Width="946px" Height="326px" BackColor="White">
    </asp:GridView>
   </td>
   </tr> 
        </table> 
