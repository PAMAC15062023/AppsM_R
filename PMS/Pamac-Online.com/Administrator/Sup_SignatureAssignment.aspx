<%@ Page Language="C#" MasterPageFile="~/Administrator/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="Sup_SignatureAssignment.aspx.cs" Inherits="Administrator_Sup_SignatureAssignment" StylesheetTheme="SkinFile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 function GetFE_Code()
   ...
   // //debugger;
           ...
           var ddlSupNameList=document.getElementById("<%=ddlSupNameList.ClientID%>");
           
           var EmployeeInfo=ddlSupNameList.value;
  ...
  <table>
        ...
        <tr>
            <td colspan="7" style="height: 20px">
                &nbsp;<strong>Supervisor Image Assignment </strong>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtSearchSupName" runat="server" MaxLength="100" SkinID="txtSkin"></asp:TextBox></td>
            <td>
                <asp:Button ID="btnSearchSup" runat="server" Text="Go" Width="33px" OnClick="btnSearchSup_Click" SkinID="btn" /></td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlSupNameList" runat="server" SkinID="ddlSkin">
                </asp:DropDownList></td>
            <td>
            ...
            <td colspan="2">
                <asp:RequiredFieldValidator ID="Rq_FEName" runat="server" ErrorMessage="Please select Supervisor Name to continue." ControlToValidate="ddlSupNameList" ValidationGroup="ValidateFE" InitialValue="--Select--"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="width: 20px">
            </td>
            <td style="width: 165px">
                Supervisor Signature Image</td>
            <td colspan="3">
                <asp:FileUpload ID="FileUpload1" runat="server" SkinID="flup" Width="330px" Height="23px" /></td>
            <td colspan="2">
                <asp:RequiredFieldValidator ID="Rq_SignImages" runat="server" ControlToValidate="FileUpload1" ErrorMessage="Please Supervisor Signature " ValidationGroup="ValidateFE"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="width: 20px">
            </td>
        ...
        <tr>
            <td colspan="7">
                ...
                <asp:GridView ID="gv_SupSignImageList" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                    <Columns>
                        ...
                        <asp:BoundField DataField="SupName" HeaderText="Supervisor Name" />
                        <asp:BoundField DataField="Sup_SignImage" HeaderText="FE_SignImage" Visible="False" />
                        ...
                        <asp:TemplateField HeaderText="Supervisor Image Signature">
                            <ItemTemplate>
