            ...
            <tr>
                <td colspan="3" >
                   ...
                   <asp:HiddenField ID="hidDupli" runat="server" />
                    ...
                    <asp:SqlDataSource ID="sdsddlCluster" runat="server" 
                        ProviderName="System.Data.OleDb" SelectCommand="select distinct CLUSTER_NAME,CLUSTER_ID from Cluater_view order by CLUSTER_NAME">
                    </asp:SqlDataSource>
                                        <asp:SqlDataSource ID="sdsddlCentre" runat="server" 
