<%@ Page Language="C#" MasterPageFile="~/Administrator/Admin_MasterPage.master" Theme="SkinFile" AutoEventWireup="true" CodeFile="Label_Template_View_Cellular.aspx.cs" Inherits="Administrator_Label_Template_View_Cellular" Title="Untitled Page" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0"> 
            ...
            <tr>
                <td style="height: 22px" >
                  ...
                  <td style="height: 22px" ><asp:DropDownList ID="ddlclient" SkinID="ddlSkin" runat="server" Width="138px" AutoPostBack="True" >
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td >Verification Type<span style="color: #ff3366">*</span>:
                </td> 
                    <td > <asp:DropDownList ID="ddlVerify" SkinID="ddlSkin" runat="server" Width="138px" DataSourceID="SqlDataSourceVerificationType" DataTextField="CASE_TYPE" DataValueField="CASE_TYPE_ID" AppendDataBoundItems="True" >
                        ...
                        SelectCommand="SELECT [CASE_TYPE_ID], [CASE_TYPE] FROM [CPV_CELLULAR_CASE_TYPE_MASTER] WHERE ([CLIENT_ID] = ?)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddlclient" Name="CLIENT_ID" PropertyName="SelectedValue"
                                Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    </td>
