    ...
    <tr>
        <td colspan="9" >
             <asp:SqlDataSource ID="sdsClient" runat="server" 
                ProviderName="System.Data.OleDb" SelectCommand="select distinct client_id,client_name from ce_ac_pr_ct_vw where product_id='1015' ">
            </asp:SqlDataSource>
            &nbsp;
            ...
            <asp:SqlDataSource ID="sdsgv" runat="server" 
                ProviderName="System.Data.OleDb" SelectCommand="select name from syscolumns WHERE id =(select id from sysobjects where name='CPV_KYC_CASE_EXPORT_VW') order by name">
            </asp:SqlDataSource>
            &nbsp;
        </td>
    </tr>
