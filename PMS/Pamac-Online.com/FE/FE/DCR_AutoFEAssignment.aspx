<%@ Page Language="C#" MasterPageFile="~/FE/FE/CC_MasterPage.master" AutoEventWireup="true" CodeFile="DCR_AutoFEAssignment.aspx.cs" Inherits="FE_FE_DCR_AutoFEAssignment" Title="Untitled Page"  Theme="SkinFile"%>
    ...
    <tr>
        ...
        <td colspan="3">
            <asp:Button ID="btnFEAutoAssignmet" runat="server" CssClass="button" OnClick="btnFEAutoAssignmet_Click"
                SkinID="btn" Text="Auto FE Assignment" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button
