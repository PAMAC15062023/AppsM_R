<%@ Page Language="C#" MasterPageFile="~/FE/FE/CC_MasterPage.master" AutoEventWireup="true" CodeFile="Dedup Search.aspx.cs" Inherits="FE_FE_Dedup_Search" Title="Untitled Page" StylesheetTheme="SkinFile" %>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td align="left"><asp:TextBox ID="txtFromDate" runat="server" SkinID="txtSkin" MaxLength="11"></asp:TextBox>
                                            <img src="../../Images/SmallCalendar.gif" alt="" onclick="popUpCalendar(this, document.all.<%=txtFromDate.ClientID%>, 'dd-mmm-yyyy', 0, 0);" />(dd-mmm-yyyy)<asp:RequiredFieldValidator
                                     ...
                                     <tr>
                                        ...
                                        <td align="left" valign="top" class="label">                                 
                                            <asp:Button ID="btnDedupeSearch" CssClass="label" runat="server" OnClick="btnDedupeSearch_Click" SkinID="btnDedupSkin" ValidationGroup="grpImport" Text="Search" />&nbsp;
                                            <asp:Button ID="btnExportToExcel" CssClass="label" runat="server" OnClick="btnExportToExcel_Click" SkinID="btnExpToExlSkin" Text="Export" />
                                        </td>
                                    </tr>
                                </table>
