<%@ Page Language="C#" MasterPageFile="~/Software Requirement/Software/MasterPage.master" AutoEventWireup="true" CodeFile="RequestApproved.aspx.cs" Inherits="Software_Requirement_Software_RequestApproved" Title="Untitled Page" StylesheetTheme="SkinFile"%>
...
function funValidateFromToDate()
{
   ...
   <asp:Panel ID="Panel1" runat="server" Width="907px"  Height="800px" >
    ...
    <table style="width: 748px">
        <tr>
            <td colspan="8" class="tta">
                Software Requirement &nbsp;Approved &nbsp;Update</td>
        </tr>
        <tr>
            <td colspan="8">
  ...
  <asp:Panel ID="Panel2" runat="server" Width="907px">
        ...
        <tr>
            ...
            <td class="Info" colspan="3" style="height: 30px">
                    <asp:Label ID="lblEmpCode" runat="server" Text="Label" Font-Bold="True"></asp:Label></td>
                     <asp:Label ID="lblTicketNo" runat="server" Text="Labe2" ForeColor="Red"></asp:Label>
        ...
        <tr>
            ...
            <td style="width: 214px; height: 22px;" class="reportTitleIncome">
                <strong>
                Last Name</strong></td>
            <td style="width: 277px; height: 22px;" class="Info">
        ...
        <tr>
            <td class="reportTitleIncome" style="width: 249px; height: 29px;">
                <strong>Vertical</strong></td>
            <td class="Info" style="width: 234px; height: 29px;">
                    <asp:Label ID="Lblvertical" runat="server" Text="Label" Font-Bold="True"></asp:Label></td>
            <td style="width: 214px; height: 29px;" class="reportTitleIncome">
                <strong>
                Vertical Head</strong></td>
            <td style="width: 277px; height: 29px;" class="Info">
        ...
        <tr>
         ...
         <td style="height: 25px" class="Info">
         <asp:TextBox ID="txtrequest" runat="server" Height="18px" SkinID="txtSkin" 
          ...
          <td class="reportTitleIncome" style="width: 249px; height: 23px">
            ...
            <td style="width: 278px; height: 23px" class="Info">
                    <asp:TextBox ID="txtrequiredtill" runat="server" Height="18px" SkinID="txtSkin" 
                    Width="120px" ReadOnly="true"></asp:TextBox></td>
        ...
        <tr>
            <td class="reportTitleIncome" style="width: 249px; height: 23px">
                <strong>
                New Requirement/Error</strong></td>
            ...
            <td style="width: 100px; height: 23px">
              ...
              <tr>
                  <td class="reportTitleIncome" style="width: 249px; height: 23px">
                      <strong>Cost Benifts</strong></td>
                  <td class="Info" colspan="3" style="height: 23px">
                      <asp:DropDownList ID="ddlcostbenifits" runat="server" SkinID="ddlSkin" Width="160px">
              ...
              <tr>
                  <td class="reportTitleIncome" style="width: 249px; height: 23px">
                      <strong>Cost Remark</strong></td>
                  <td class="Info" colspan="3" style="height: 23px">
                      <asp:TextBox ID="txtcostremark" runat="server" SkinID="txtSkin" Width="468px" TextMode="MultiLine"></asp:TextBox></td>
                  <td style="width: 100px; height: 23px">
                  </td>
                  <td style="width: 100px; height: 23px">
                  </td>
              ...
              <tr>
                  <td class="reportTitleIncome" style="width: 249px; height: 20px">
                      <strong>
                    Expected Date</strong></td>
                  <td class="Info" colspan="3" style="height: 20px">
                    <asp:TextBox ID="txtExpectedDate" runat="server" Height="16px" Width="85px"  SkinID="txtSkin"></asp:TextBox><img alt="Calendar" onclick="popUpCalendar(this, document.all.<%=txtExpectedDate.ClientID%>, 'dd/mm/yyyy', 0, 0);"
                        src="../../Images/SmallCalendar.gif" /></td>
                  <td style="width: 100px; height: 20px">
                  </td>
                  <td style="width: 100px; height: 20px">
              ...
              <tr>
                  ...
                  <td class="Info" colspan="3" style="height: 21px">
                    <asp:TextBox ID="txtRemark" runat="server" Height="30px" TextMode="MultiLine" Width="450px" SkinID="txtSkin"></asp:TextBox></td>
                  ...
                  <td style="width: 100px; height: 21px">
                <%--   CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Attachment1")%>'--%>
                  </td>
              </tr>
              <tr>
        ...
        <tr>
            ...
            <center><asp:Button ID="BtnActionSave" runat="server" Text="Approve" SkinID="btn" Width="100px" ValidationGroup="grpSearch" OnClick="BtnActionSave_Click" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="BtnReject" runat="server"
                    OnClick="BtnReject_Click" SkinID="btn" Text="Reject " Width="88px" />
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <asp:Button ID="btnBack" runat="server" OnClick="btnBack_Click" SkinID="btnBackSkin" Text="Back" Width="100px" />
            &nbsp; &nbsp;<asp:Button ID="BtnReset12" runat="server" Text="Reset" SkinID="btn" Width="100px" OnClick="BtnReset12_Click"  />&nbsp;
            
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Button ID="btndelete" runat="server"
                    OnClick="btndelete_Click" SkinID="btn" Text="Delete " Width="88px" onclientclick="return confirm('Do you want to delete this record?');" />
        ...
        <tr>
            <td colspan="8">
                ...
                <asp:HiddenField ID="hdnclusterid" runat="server" /><asp:HiddenField ID="hdncentreid" runat="server" />
            </td>
        </tr>
    </table>
    </asp:Panel>
