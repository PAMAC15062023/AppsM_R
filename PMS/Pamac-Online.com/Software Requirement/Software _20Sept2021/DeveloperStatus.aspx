...
<asp:Label ID="lblmsg" runat="server" SkinID="lblErrorMsg" ForeColor="Red"></asp:Label>
    ...
    <table style="width: 748px">
        ...
        <tr>
            <td style="height: 21px;" colspan="6">
                <asp:Button ID="Btnsearch" runat="server" Height="23px"  SkinID="btn"
                    Text="Search" Width="121px"  ValidationGroup="grpSearch" OnClick="Btnsearch_Click" />&nbsp;
        ...
        <tr>
            ...
            <asp:Label ID="lblTikectNo" runat="server" Text="Tikect No" Font-Bold="True"></asp:Label><td style="width: 100px; height: 30px;">
            </td>
            <td style="width: 100px; height: 30px;">
            </td>
            <td style="width: 100px; height: 30px;">
            ...
            <td style="width: 100px; height: 21px;">
              ...
              <tr>
                  ...
                  <td class="Info" colspan="3" style="height: 21px">
                      <asp:TextBox ID="txtrootcause" runat="server" SkinID="txtSkin"  TextMode="multiLine" Width="448px"></asp:TextBox></td>
                  <td style="width: 100px; height: 21px">
                  </td>
                  <td style="width: 100px; height: 21px">
                  </td>
              ...
              <tr>
                  ...
                  <td class="Info" colspan="3" style="height: 21px">
                      <asp:TextBox ID="txtDeveloperremark" runat="server" SkinID="txtSkin"  TextMode="multiLine" Width="447px"></asp:TextBox></td>
                  <td style="width: 100px; height: 21px">
                  </td>
                  <td style="width: 100px; height: 21px">
                  </td>
        ...
        <tr>
            ...
            <center><asp:Button ID="BtnActionSave" runat="server" Text="Submit" SkinID="btn" Width="100px" OnClick="BtnActionSave_Click1" Onclientclick = "return check()"   />
            &nbsp; &nbsp;<asp:Button ID="btnBack" runat="server"  SkinID="btnBackSkin" Text="Back" Width="100px" />
            &nbsp; &nbsp;<asp:Button ID="BtnReset12" runat="server" Text="Reset" SkinID="btn" Width="100px" OnClick="BtnReset12_Click" /></center> </td>
            <td style="width: 100px; height: 21px;">
                &nbsp;</td>
            <td style="width: 100px; height: 21px;">
            </td>
