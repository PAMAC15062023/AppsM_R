...
public partial class Software_Requirement_Software_UploadProcessAndPolicies : System.Web.UI.Page
{
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        string folderPathLatest = Server.MapPath("~/Software Requirement/Software/LatestPoicy/");

        string folderPathArchive = Server.MapPath("~/Software Requirement/Software/ArchivePolicy/");
