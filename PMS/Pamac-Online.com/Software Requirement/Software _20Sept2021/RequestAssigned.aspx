...
<%--     <script language="javascript" type="text/javascript">
     ...
     function check()
{
var a = document.getElementById('ct100_C1_txttechnicalproblm').value;
var b = document.getElementById('ct100_C1_txtRemark').value;
If(a=='' && b== '')
{
...
return true;
   ...
   </script>   --%><%--<script language="javascript" type="text/javascript" src="../../popcalendar.js">
   --%>
   <script language="javascript" type="text/javascript">
  ...
  <table style="width: 748px">
        <tr>
            <td colspan="8" class="tta">
                Software Requirement &nbsp;Assigned To
            </td>
        </tr>
        <tr>
            <td colspan="8">
        ...
        <tr>
            ...
            <td style="width: 100px; height: 30px;">
             ...
             <asp:Label ID="lbltickNo" runat="server" Text="" ForeColor="Red"></asp:Label><td style="width: 100px; height: 30px;">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <center><asp:Button ID="BtnActionSave" runat="server" Text="Submit" SkinID="btn" Width="100px"  OnClick="BtnActionSave_Click"  />
