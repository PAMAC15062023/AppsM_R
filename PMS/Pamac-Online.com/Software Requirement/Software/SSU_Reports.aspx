<%@ Page Title="" Language="C#" MasterPageFile="~/Software Requirement/Software/MasterPage.master" AutoEventWireup="true" CodeFile="SSU_Reports.aspx.cs" Inherits="Software_Requirement_Software_SSU_Reports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="C1" runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="900px">
        <table style="width: 748px">
            <tr>
                <td colspan="8" class="tta">Software Requirement &nbsp;&nbsp;Status</td>
            </tr>
            <tr>
                <td colspan="8">
            ...
            <tr style="color: #000000; font-family: Tahoma">
                ...
                <td style="width: 100px; height: 20px;" class="Info">
                    <asp:DropDownList ID="ddlcentre" runat="server" AutoPostBack="True" 
                        SkinID="ddlSkin" Width="150px" ValidationGroup="grpSearch" OnSelectedIndexChanged="ddlcentre_SelectedIndexChanged">
                    </asp:DropDownList></td>
            ...
            <tr>
                <td style="height: 21px;" colspan="8">
                    <asp:Button ID="Btnsearch" runat="server" Height="23px" SkinID="btn" OnClick="Btnsearch_Click"
                        Text="Search" Width="121px" ValidationGroup="grpSearch" />&nbsp;
                <asp:Button ID="BtnReset" runat="server" Height="23px" SkinID="btn" OnClick="BtnReset_Click"
                    Text="Reset" Width="121px" />
                    <asp:Button ID="btnExport" runat="server" Height="23px" SkinID="btn" OnClick="btnExport_Click"
