<%@ Page Language="C#" MasterPageFile="~/Software Requirement/Software/MasterPage.master"
    AutoEventWireup="true" CodeFile="SSURequest.aspx.cs" Inherits="Software_Requirement_Software_SSURequest"
...
{
var input = document.getElementById('ctl00_C1_txtToDate').value;
...
{
alert('Please Insert correct Date Format for required till date');
return false;
}
}
    </script>
...
if(pattern.test(input) == true)
{
var file1 = document.getElementById('ctl00_C1_FileUpload1').value;
var down1 = document.getElementById('ctl00_C1_lnkdownload1');

if(down1  != null && file1 != "") 
{
if(confirm('Previous Process Flow File will be overridden, Do You want to Continue ??') == true)
{
 return true;
}
else
...
var file2 = document.getElementById('ctl00_C1_FileUpload2').value;
var down2 = document.getElementById('ctl00_C1_lnkdownload2');

if(down2  != null && file2 != "") 
{
if (confirm('Previous Import / Export File will be overridden, Do You want to Continue ??') == true )
{
 return true;
}
else
...
var file3 = document.getElementById('ctl00_C1_FileUpload3').value;
var down3 = document.getElementById('ctl00_C1_lnkdownload3');

if(down3  != null && file3 != "") 
{
if (confirm('Previous MIS Tracker File will be overridden, Do You want to Continue ??') == true)
{
 return true;
}
else
...
var down1 = document.getElementById('ctl00_C1_lnkdownload1');
if(down1  != null && file1 != "") {
if(confirm('Previous Process Flow File will be overridden, Do You want to Continue ??');)
}
else {
 return true;
 }
var file2 = document.getElementById('ctl00_C1_FileUpload2').value;
var down2 = document.getElementById('ctl00_C1_lnkdownload2');
if(down2  != null && file2 != "") if( confirm('Previous Import / Export File will be overridden, Do You want to Continue ??');}
else return true;
var file3 = document.getElementById('ctl00_C1_FileUpload3').value;
var down3 = document.getElementById('ctl00_C1_lnkdownload3');
if(down3  != null && file3 != "") if{ confirm('Previous MIS Tracker File will be overridden, Do You want to Continue ??');}
else return true;
}
...
{  
        ...
        <table style="width: 700px;">
            <tr>
                <td class="tta" colspan="6" style="width: 711px">
                    <strong>Software Development Requirement </strong>
                </td>
            </tr>
            <tr>
                <td colspan="6" style="height: 21px; width: 711px;">
                    <asp:Label ID="lblprint" runat="server" ForeColor="Red" SkinID="lblError"></asp:Label>
            ...
            <tr>
                <td colspan="6" style="height: 21px; width: 711px;">
                    <asp:LinkButton ID="lnkststus" runat="server" Font-Bold="True" PostBackUrl="~/Software Requirement/Software/SSU_Status.aspx"
                        Font-Size="Small" ForeColor="DeepSkyBlue">All Request Status</asp:LinkButton></td>
            </tr>
            <tr>
                <td style="width: 249px" class="reportTitleIncome">
                    <strong>Employee Code</strong></td>
                <td class="Info" colspan="3">
                    <asp:TextBox ID="txtEmpCode" runat="server" SkinID="txtSkin" AutoPostBack="True"
                        OnTextChanged="txtEmpCode_TextChanged" Width="150px"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td class="Info" style="width: 234px; height: 23px">
                    <asp:TextBox ID="txtFromDate" runat="server" SkinID="txtSkin" ValidationGroup="grpSearch"
                        Width="71px" ReadOnly="true" Enabled="false"></asp:TextBox>
                ...
                <td style="width: 104px; height: 23px" class="Info">
                    <asp:TextBox ID="txtToDate" runat="server" SkinID="txtSkin" ValidationGroup="grpSearch"
                        Width="71px"></asp:TextBox><img alt="Calendar" onclick="popUpCalendar(this, document.all.<%=txtToDate.ClientID%>, 'dd/mm/yyyy', 0, 0);"
                            src="../../Images/SmallCalendar.png" /><br />
                    [dd/mm/yyyy]</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="reportTitleIncome" style="width: 249px; height: 23px">
                    <strong>Requirement Type</strong></td>
                <td class="Info" style="width: 234px; height: 23px">
                    <asp:DropDownList ID="ddlreqtype" runat="server" AutoPostBack="True" SkinID="ddlSkin"
                        Width="155px" OnSelectedIndexChanged="ddlreqtype_SelectedIndexChanged" ValidationGroup="grpSearch">
                ...
                <td class="Info" style="width: 104px; height: 23px">
                    ...
                    <asp:DropDownList ID="ddlrequirement" runat="server" AutoPostBack="true" SkinID="ddlSkin"
                        Width="158px" OnSelectedIndexChanged="ddlrequirement_SelectedIndexChanged">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td class="reportTitleIncome" style="width: 249px; height: 23px">
        ...
        <table style="width: 698px;">
            <tr>
                ...
                <td class="Info" style="width: 172px; height: 23px">
                    <asp:DropDownList ID="ddlclientactivity" runat="server" AutoPostBack="true" SkinID="ddlSkin"
                        ddSkinID="ddlSkin" Width="160px" OnSelectedIndexChanged="ddlclientactivity_SelectedIndexChanged">
                    </asp:DropDownList></td>
                <td class="reportTitleIncome" style="width: 203px; height: 23px">
                    <strong>Product </strong>
                </td>
                <td class="Info" style="width: 93px; height: 23px">
                    <asp:DropDownList ID="ddlclientproduct" runat="server" AutoPostBack="False" SkinID="ddlSkin"
                        Width="160px">
                    </asp:DropDownList></td>
                <tr>
                    <td class="reportTitleIncome" style="width: 181px; height: 23px">
        ...
        <table style="width: 698px;">
            <tr>
                <td class="reportTitleIncome" style="width: 181px; height: 23px">
                    <strong>Activity</strong></td>
                <td class="Info" style="width: 172px; height: 23px">
                    <asp:DropDownList ID="ddlrightactivity" runat="server" AutoPostBack="true" SkinID="ddlSkin"
                        ddSkinID="ddlSkin" Width="160px" OnSelectedIndexChanged="ddlrightactivity_SelectedIndexChanged">
                    </asp:DropDownList></td>
                <td class="reportTitleIncome" style="width: 203px; height: 23px">
                    <strong>Product </strong>
                </td>
                <td class="Info" style="width: 104px; height: 23px">
                    <asp:DropDownList ID="ddlrightproduct" runat="server" AutoPostBack="True" SkinID="ddlSkin"
                        Width="160px" OnSelectedIndexChanged="ddlproduct_SelectedIndexChanged">
                    </asp:DropDownList></td>
                <tr>
                    <td class="reportTitleIncome" style="width: 181px; height: 23px">
                        <strong>Emp code </strong>
                    ...
                    <td class="reportTitleIncome" style="width: 165px; height: 23px">
                        <strong>Assign Right details </strong>
                    </td>
                    <td style="width: 104px; height: 22px;" class="Info">
    ...
    <asp:Panel ID="pnlautoreply" runat="server" Width="701px">
        <table style="width: 698px;">
            <tr>
                ...
                <td class="reportTitleIncome" style="width: 165px; height: 23px">
                    <strong>Auto Reply Remark </strong>
                </td>
                <td style="width: 104px; height: 22px;" class="Info">
                    <asp:TextBox ID="txtautoreplyremerk" runat="server" SkinID="txtSkin" TextMode="MultiLine"
            ...
            <tr>
                ...
                <td class="Info" style="width: 234px; height: 23px">
                    <asp:TextBox ID="txtstartfrom" runat="server" SkinID="txtSkin" ValidationGroup="grpSearch"
                        Width="71px"></asp:TextBox><img alt="Calendar" onclick="popUpCalendar(this, document.all.<%=txtstartfrom.ClientID%>, 'dd/mm/yyyy', 0, 0);"
                            src="../../Images/SmallCalendar.png" /><br />
                    [dd/mm/yyyy]</td>
                <td class="reportTitleIncome" style="width: 165px; height: 23px">
                    <strong>End To</strong></td>
                <td class="Info" style="width: 234px; height: 23px">
                    <asp:TextBox ID="txtendto" runat="server" SkinID="txtSkin" ValidationGroup="grpSearch"
                        Width="71px"></asp:TextBox><img alt="Calendar" onclick="popUpCalendar(this, document.all.<%=txtendto.ClientID%>, 'dd/mm/yyyy', 0, 0);"
                            src="../../Images/SmallCalendar.png" /><br />
                    [dd/mm/yyyy]</td>
            </tr>
        </table>
        ...
        <table style="width: 698px;">
            <tr>
                <td class="reportTitleIncome" style="width: 178px; height: 23px">
                    <strong>Activity</strong></td>
                <td class="Info" style="width: 172px; height: 23px">
                    <asp:DropDownList ID="ddlactivity" runat="server" AutoPostBack="true" SkinID="ddlSkin"
                        OnSelectedIndexChanged="ddlactivity_SelectedIndexChanged" ddSkinID="ddlSkin"
                        Width="160px">
                    </asp:DropDownList></td>
                <td class="reportTitleIncome" style="width: 203px; height: 23px">
                    <strong>Product </strong>
                ...
                <td class="Info" style="width: 93px; height: 23px">
                    <asp:DropDownList ID="ddlproduct" runat="server" AutoPostBack="True" SkinID="ddlSkin"
                        Width="160px" OnSelectedIndexChanged="ddlproduct_SelectedIndexChanged">
                    </asp:DropDownList></td>
                <tr>
                    <td class="reportTitleIncome" style="width: 178px; height: 23px">
        ...
        <table style="width: 700px;">
            <tr>
                ...
                <td class="Info" colspan="3" style="height: 21px">
                    <asp:FileUpload ID="FileUpload1" runat="server" SkinID="flup" Width="290px" />
                    <asp:LinkButton ID="lnkdownload1" runat="server" Text="Download" OnClick="lnkdownload1_Click"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                ...
                <td class="Info" colspan="3" style="height: 21px">
                    <asp:FileUpload ID="FileUpload2" runat="server" SkinID="flup" Width="290px" />
                    <asp:LinkButton ID="lnkdownload2" runat="server" Text="Download" OnClick="lnkdownload2_Click"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td class="reportTitleIncome" style="width: 151px; height: 21px">
                ...
                <td class="Info" colspan="3" style="height: 21px">
                    <asp:FileUpload ID="FileUpload3" runat="server" SkinID="flup" Width="290px" />
                    <asp:LinkButton ID="lnkdownload3" runat="server" Text="Donwload" OnClick="lnkdownload3_Click"></asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td class="reportTitleIncome" style="width: 151px; height: 21px">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt">
                        <font color="#000080"><span style="font-size: 8pt; width: 430px; color: black; height: 21px">
                            <strong>Technical Problem / Issues in the Application</strong></span></font></p>
                </td>
            ...
            <tr>
                ...
                <td colspan="3" style="height: 21px" class="Info">
                    <asp:TextBox ID="txtSuggestion" runat="server" SkinID="txtSkin" Height="44px" TextMode="MultiLine"
                        Width="400px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="height: 21px; width: 249px" class="Info" colspan="4" align="center">
                    &nbsp; &nbsp;<asp:Button ID="btnupadte" runat="server" Visible="false" OnClientClick="return checkfiles();"
                        OnClick="btnupadte_Click" SkinID="btn" Text="Update" ValidationGroup="grpSearch"
                        Width="100px" />
                    &nbsp; &nbsp;<asp:Button ID="BtnSave" runat="server" OnClick="BtnSave_Click" SkinID="btn"
                        Text="Save" ValidationGroup="grpSearch" OnClientClick="return checkdateformat();" Width="100px" />
                    &nbsp;
                    <asp:Button ID="BtnReset" runat="server" SkinID="btn" Text="Reset" Width="100px"
       OnClick="BtnReset_Click" />
                    &nbsp;&nbsp; &nbsp;
                    <%-- <asp:Button ID="btndelte" runat="server" SkinID="btn"  Visible="false" Text="Delete" Width="100px" OnClick="btndelte_Click"/>
                &nbsp;&nbsp; &nbsp;--%>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td colspan="8" style="width: 391px; height: 211px;">
                    ...
                    <asp:GridView ID="grdGrid" runat="server" SkinID="gridviewSkin" OnRowDataBound="grdGrid_RowDataBound"
                        OnRowCommand="grdGrid_RowCommand" OnSelectedIndexChanged="grdGrid_SelectedIndexChanged">
                        <%--      add by prajakta--%>
                        <Columns>
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <asp:HiddenField  ID="hdnStatus" runat="server" Value= '<%# Eval("Approval Status") %>'/>
                                    <asp:LinkButton ID="lnkedit" runat="server" Text="Edit" CommandName="DoEdit" CommandArgument='<%# Eval("TicketNo") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <%-- commented by prajakta
                 --%>
                        <%--  <Columns>--%>
                        <%--
                   <asp:TemplateField>
   ...
   <asp:CustomValidator ID="CVCcompany"
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlvertical"
        Display="None" ErrorMessage="Please select the vertical." SetFocusOnError="True"
        InitialValue="--Select--" ValidationGroup="grpSearch"></asp:RequiredFieldValidator>
</asp:Content>
