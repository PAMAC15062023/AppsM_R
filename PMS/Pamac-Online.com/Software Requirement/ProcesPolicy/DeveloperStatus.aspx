...
function funValidateFromToDate()
{
    ...
    <table style="width: 748px">
        ...
        <tr>
            ...
            <td style="width: 100px; height: 21px;">
              ...
              <tr>
                  ...
                  <td class="Info" colspan="3" style="height: 21px">
                      <asp:TextBox ID="Txtoverallremark" runat="server" SkinID="txtSkin"  TextMode="multiLine" Width="444px"></asp:TextBox></td>
                  <td style="width: 100px; height: 21px">
                  </td>
                  <td style="width: 100px; height: 21px">
                  </td>
        ...
        <tr>
            ...
            <center><asp:Button ID="BtnActionSave" runat="server" Text="Submit" SkinID="btn" Width="100px" OnClick="BtnActionSave_Click1"   />
