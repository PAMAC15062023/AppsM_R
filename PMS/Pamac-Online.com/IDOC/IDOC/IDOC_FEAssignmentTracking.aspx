 ...
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <asp:ValidationSummary ID="ValidationSummary2" runat="server" DisplayMode="List"
     ...
     SelectCommand="Select [VERIFICATION_TYPE_ID], [VERIFICATION_TYPE_CODE] from VERIFICATION_TYPE_MASTER 
               WHERE VERIFICATION_TYPE_ID IN(5,6,7,8,9,11) AND (PARENT_TYPE_CODE = 'DV')"></asp:SqlDataSource>
...
<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="IDOC_MasterPage.master" Theme="SkinFile" CodeFile="IDOC_FEAssignmentTracking.aspx.cs" Inherits="IDOC_IDOC_IDOC_FEAssignmentTracking" %>
