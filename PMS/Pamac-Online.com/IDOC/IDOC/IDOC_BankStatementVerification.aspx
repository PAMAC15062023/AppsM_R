...
<table border="0" cellpadding="1" cellspacing="0" width="100%" id="tblMain" style="background-color:#E7F6FF">
    ...
    <asp:DropDownList SkinID="ddlSkin" ID="ddlCorrectAmtAsPerBankStat" runat="server"  AutoPostBack="false">
        ...
        <td>
            :</td>
        <td>
            <asp:TextBox ID="txtBankAccountNo" runat="server" SkinID="txtSkin"></asp:TextBox></td>
    </tr>    
    </table>    
    </td>
    </tr>
    ...
    <td style="width:58%">
    <asp:TextBox SkinID="txtSkin" ID="txtRemarks" runat="server" Width="92%" TextMode="multiLine" onkeyPress="ValidateTextLength('Remark', this, 2000);"></asp:TextBox>
    </td>
    </tr>
    </table>
    </td>
    ...
    <td style="width:25%">
        ...
        <tr>
            <td style="width: 10%">
                <asp:Label ID="labAreaname" runat="server" SkinID="lblSkin" Width="86px">Area Name</asp:Label>
                <asp:Label ID="lblareaerror" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label></td>
            <td style="width: 2%">
            </td>
            <td style="width: 20%">
                <asp:DropDownList ID="ddlAreaname" runat="server" OnSelectedIndexChanged="ddlSupervisorName_SelectedIndexChanged" AutoPostBack="true"
                    SkinID="ddlSkin">  </asp:DropDownList>
