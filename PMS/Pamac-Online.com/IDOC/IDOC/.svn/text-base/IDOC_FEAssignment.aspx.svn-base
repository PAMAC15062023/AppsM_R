<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="IDOC_MasterPage.master"  CodeFile="IDOC_FEAssignment.aspx.cs" Inherits="IDOC_IDOC_IDOC_FEAssignment" Theme="SkinFile" %>
...
<fieldset><legend class="FormHeading">FE Assignment</legend>
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <tr><td  >
        ...
        <tr>
        <td >Verification Type</td><td>:</td><td>
                <asp:DropDownList ID="ddlType" runat="server" DataSourceID="sdsVeriType" DataTextField="VERIFICATION_TYPE" DataValueField="VERIFICATION_TYPE_ID" OnDataBound="ddlType_DataBound" AutoPostBack="false" SkinID="ddlSkin">
                </asp:DropDownList>
        </td>
                <td >
                </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td style="width: 112px" >From Pincode</td><td style="width: 2px">:</td><td>
    ...
    <tr><td>        
        <asp:GridView ID="gvFEAssignmentCases" runat="server" DataSourceID="sdsGV" OnPageIndexChanging="gvFEAssignmentCases_PageIndexChanging" Width="100%" OnSorting="gvFEAssignmentCases_Sorting" SkinID="gridviewSkin" OnDataBound="gvFEAssignmentCases_DataBound">           
           ...
           <HeaderTemplate >
                ...
                <ItemTemplate>
                    <asp:CheckBox ID="chkCaseId" align="center"  runat="server" /><asp:HiddenField ID="hidCaseId" runat="server"
    ...
    <tr><td align="right"><asp:Button ID="btnAssign1" runat="server" SkinId="btnAssingSkin" OnClick="btnAssign_Click" ValidationGroup="vgrpFE" /></td></tr>
     ...
     <asp:SqlDataSource ID="sdsVeriType" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>" ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>" SelectCommand="SELECT VERIFICATION_TYPE_ID, VERIFICATION_TYPE FROM VERIFICATION_TYPE_MASTER WHERE (ACTIVITY_ID = '1012') AND (PARENT_TYPE_CODE = 'DV') order by  VERIFICATION_TYPE"></asp:SqlDataSource>
