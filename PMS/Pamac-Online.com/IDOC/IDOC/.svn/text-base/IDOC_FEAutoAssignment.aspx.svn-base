<%@ Page Language="C#" MasterPageFile="~/IDOC/IDOC/IDOC_MasterPage.master" AutoEventWireup="true" CodeFile="IDOC_FEAutoAssignment.aspx.cs" Inherits="IDOC_IDOC_IDOC_FEAutoAssignment" Theme="skinFile"%>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlType" runat="server" AutoPostBack="false" DataSourceID="sdsVeriType"
                DataTextField="VERIFICATION_TYPE" DataValueField="VERIFICATION_TYPE_ID" SkinID="ddlSkin">
            </asp:DropDownList></td>
...
<tr>
    <td colspan="6">
        <asp:SqlDataSource ID="sdsVeriType" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"
            ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>" SelectCommand="SELECT VERIFICATION_TYPE_ID, VERIFICATION_TYPE FROM VERIFICATION_TYPE_MASTER WHERE (ACTIVITY_ID = '1012') AND (PARENT_TYPE_CODE = 'DV') order by  VERIFICATION_TYPE">
        </asp:SqlDataSource>
    </td>
</tr>
