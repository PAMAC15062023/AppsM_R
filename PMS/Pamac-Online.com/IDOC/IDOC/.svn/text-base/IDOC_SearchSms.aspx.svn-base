<%@ Page Language="C#" MasterPageFile="~/IDOC/IDOC/IDOC_MasterPage.master" AutoEventWireup="true" Theme="SkinFile" CodeFile="IDOC_SearchSms.aspx.cs" Inherits="IDOC_IDOC_IDOC_SearchSms" %>
