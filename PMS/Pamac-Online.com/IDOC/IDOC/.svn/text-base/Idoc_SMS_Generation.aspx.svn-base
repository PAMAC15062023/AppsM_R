<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="IDOC_MasterPage.master" Theme="SkinFile"  CodeFile="Idoc_SMS_Generation.aspx.cs" Inherits="IDOC_IDOC_Idoc_SMS_Generation" %>
