<%@ Page Language="C#" MasterPageFile="~/IDOC/IDOC/IDOC_MasterPage.master" AutoEventWireup="true" CodeFile="IDOC_SendToClientFinal.aspx.cs" Inherits="IDOC_IDOC_IDOC_SendToClientFinal" Theme="skinFile"%>
...
<td colspan="5">
   ...
   <tr id="TRTAT" runat="server">
    ...
    <td>
    <asp:TextBox id="txtSendTm" runat="server" ReadOnly="true" ValidationGroup="grpSend" MaxLength="5" SkinID="txtSkin"  CssClass="textbox"></asp:TextBox>
...
<asp:ValidationSummary ID="valSummary" runat="server" DisplayMode="List" ShowMessageBox="True" 
    ...
    <tr>
        <td colspan="5"> <asp:GridView ID="GridView1" runat="server" BorderColor="white" GridLines="None">
                        ...
                        <AlternatingRowStyle BackColor="White" ForeColor="White"   />
                                ...
                                <asp:HiddenField ID="hdfrec_date" runat="server" />
        </td>
    </tr>
</table>
</fieldset>
