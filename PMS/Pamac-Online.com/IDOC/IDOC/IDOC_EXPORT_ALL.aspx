<%@ Page Language="C#" MasterPageFile="~/IDOC/IDOC/IDOC_MasterPage.master" AutoEventWireup="true" CodeFile="IDOC_EXPORT_ALL.aspx.cs" Inherits="IDOC_IDOC_IDOC_EXPORT_ALL" Title="Idoc Export" StylesheetTheme="SkinFile" Theme="SkinFile" %>
...
<fieldset><legend class="FormHeading">Idoc - Export</legend>
<br />
   ...
   <tr><td colspan="11"><hr /></td></tr>
    <tr>
        ...
        <td align="right" valign="top" style="text-align: left" >
           <asp:Button ID="btnSearch" runat="server" ValidationGroup="vgrpExcelReport" OnClick="btnSearch_Click" Font-Bold="True" Text="Search" Width="78px" />
        </td>
    </tr>   
    <tr>
        ...
        <tr>
            <td class="TDWidth" colspan="3">
                <table id="tblCaseCount" runat="server" visible="false" width="100%">
                    <tr><td colspan="4">
                    <asp:HyperLink ID="hplDownload" runat="server" Target="_blank" Visible="False" Font-Bold="True" ForeColor="#3300FF">Download Reports</asp:HyperLink>
                    </td></tr>
                    <tr>
        ...
        DataKeyNames="CASE_ID" Width="100%" PageSize="100" AllowPaging="True" OnDataBound ="gvOutput_DataBound" >
            <Columns>
                ...
                <asp:BoundField DataField="APPLICANT_NAME" HeaderText="Applicant Name" ReadOnly="True"
                 ...
                 <asp:TemplateField HeaderText="VERIFICATION_CODE" SortExpression="VERIFICATION_CODE">
                    <EditItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Eval("VERIFICATION_CODE") %>'></asp:Label>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("VERIFICATION_CODE") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:HiddenField ID="hidCaseId" runat="server"
                        Value='<%# DataBinder.Eval(Container.DataItem, "CASE_ID") %>' />
                         <asp:HiddenField ID="hidVeriType" runat="server"
                        Value='<%# DataBinder.Eval(Container.DataItem, "VERIFICATION_CODE") %>' />
                </ItemTemplate>
