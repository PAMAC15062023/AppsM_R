...
<tr>
    <td colspan="6">
        <asp:SqlDataSource ID="sdsVeriType" runat="server" 
            ProviderName="System.Data.OleDb" SelectCommand="SELECT VERIFICATION_TYPE_ID, VERIFICATION_TYPE FROM VERIFICATION_TYPE_MASTER WHERE (ACTIVITY_ID = '1012') AND (PARENT_TYPE_CODE = 'DV') order by  VERIFICATION_TYPE">
        </asp:SqlDataSource>
    </td>
</tr>
