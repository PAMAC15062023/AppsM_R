<%@ Page Language="C#" MasterPageFile="IDOC_MasterPage.master" AutoEventWireup="true" Theme="SkinFile" CodeFile="IDOC_DV_ITR.aspx.cs" Inherits="IDOC_IDOC_IDOC_DV_ITR" StylesheetTheme="SkinFile" %>
...
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin"   ID="txtTotalIncomeasperITR" runat="server" TabIndex="4"></asp:TextBox>
</td>
...
<asp:ListItem Text="UTV" Value="UTV"></asp:ListItem>
    ...
    <tr>
        <td colspan="1">
            <asp:Label ID="Label1" runat="server" SkinID="lblSkin">CA Membership Stamp Available</asp:Label></td>
        <td style="width: 2%">
            :</td>
        <td>
            <asp:DropDownList ID="ddlCaMem" runat="server" AutoPostBack="false" SkinID="ddlSkin" TabIndex="13">
                <asp:ListItem Text="Yes" Value="Yes"></asp:ListItem>
                <asp:ListItem Text="No" Value="No"></asp:ListItem>
                <asp:ListItem Text="UTV" Value="UTV"></asp:ListItem>
            </asp:DropDownList></td>
        <td colspan="6">
            <asp:Label ID="Label2" runat="server" SkinID="lblSkin" Width="235px">If Available does the membership details match</asp:Label><asp:TextBox ID="txtCaMemDet" runat="server" MaxLength="255" SkinID="txtSkin" TabIndex="14"
...
<td style="width: 459px">
    &nbsp;<asp:Label ID="lblSupervisorName" runat="server" SkinID="lblSkin" Text="Supervisor Name"></asp:Label></td>
    <td style="width: 459px">
        <asp:DropDownList ID="ddlSupervisorName" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSupervisorName_SelectedIndexChanged"
            SkinID="ddlSkin" Width="135px">   
        </asp:DropDownList></td> 
    <td style="width: 459px">
    <asp:Label SkinID="lblSkin" ForeColor="Red" Font-Bold="true"  ID="lblvalid" runat="server" Text="Supervisor Name Is Mandatory"></asp:Label>
    </td>
    <td style="width: 459px">
    </td>
<td style="width:2%"></td>
...
<tr><td colspan="12"><asp:HiddenField ID="hidCaseID" runat="server" />
