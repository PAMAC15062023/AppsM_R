    ...
    <table class="roundedCorners">
        ...
        <tr>
            <td style="width: 164px">
                ...
                <img src="Captcha2.aspx" />
            </td>
            <td>
                <span style="color: #ff0000">*</span></td>
            <td style="width: 100px">
                <asp:TextBox ID="txtCaptcha" runat="server" SkinID="txtSkin" Width="131px"></asp:TextBox></td>
            <td colspan="2">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtNewPwd"
                    ErrorMessage="Minimum Length should be 9 Characters longs!" ValidationExpression="^.{8,}$"
        ...
        <tr>
            ...
            <asp:Button ID="btnLogin" runat="server" CausesValidation="False" OnClick="btnLogin_Click" Text="Login Again" Visible="False" /></td>
            <td style="width: 100px">
            </td>
            <td style="width: 100px">
            </td>
