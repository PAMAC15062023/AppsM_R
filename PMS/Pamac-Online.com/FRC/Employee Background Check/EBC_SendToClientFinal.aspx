<%@ Page Language="C#" MasterPageFile="~/FRC/Employee Background Check/EBC_MasterPage.master" AutoEventWireup="true" CodeFile="~/FRC/Employee Background Check/EBC_SendToClientFinal.aspx.cs" Inherits="CPV_EBC_EBC_SendToClientFinal" Theme="skinFile" StylesheetTheme="SkinFile" %>
...
<td colspan="6">
    ...
    <td class="reportTitleIncome" style="width: 69px"><asp:Label id="lblsenddate"  runat="server" SkinID="lblSkin" Text="Send Date" ></asp:Label>*</td>
    ...
    <td class="reportTitleIncome" style="width: 70px"><asp:Label id="lblsendtime" runat="server" SkinID="lblSkin" Text="Send Time "></asp:Label>*</td>
