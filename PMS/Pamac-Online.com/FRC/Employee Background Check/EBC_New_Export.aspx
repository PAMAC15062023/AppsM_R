<%@ Page Language="C#" MasterPageFile="~/FRC/Employee Background Check/EBC_MasterPage.master" AutoEventWireup="true" CodeFile="EBC_New_Export.aspx.cs" Inherits="EBC_New_EBC_New_Export" Theme="SkinFile" StylesheetTheme="SkinFile" %>
...
<table id="tblExport" width="100%" cellpadding="2" cellspacing="1" border="0">
    <tr>
        <td align="left" valign="top" colspan="8">
                    <asp:Label ID="lblMsg" runat="server" Width="100%" CssClass="ErrorMessage"></asp:Label></td>
    </tr>
    <tr>
        <td class="topbar" colspan="10" style="height: 35px">
            &nbsp;Export</td>
    </tr>
    <tr>
        <td align="left" valign="top" style="width: 95px; height: 22px;" class="Info">
            <asp:RadioButton ID="rdoFromToDate" runat="server" Checked="true" GroupName="SelectDateCriteria"
                /></td>
        <td align="left" class="reportTitleIncome" colspan="2" style="height: 22px" valign="top">
            From</td>
    <td align="left" valign="top" style="width: 213px; height: 22px" class="Info" >
    ...
    <img alt="Calendar" onclick="popUpCalendar(this, document.all.ctl00$C1$txtFromDate, 'dd/mm/yyyy', 0, 0);"
        ...
        <td align="left" class="reportTitleIncome" colspan="2" style="height: 22px" valign="top">
            To</td>
    <td align="left" valign="top" style="height: 22px" class="Info" >
    ...
    <tr>
        <td align="left" valign="top" style="width: 95px; height: 4px;" class="Info" >
            <asp:RadioButton ID="rdoDateTime" runat="server" GroupName="SelectDateCriteria"/></td>
        <td align="left" style="height: 4px;" valign="top" class="reportTitleIncome" colspan="2">
            Date</td>
        <td align="left" valign="top" style="width: 213px; height: 4px;" class="Info" >
            ...
            src="../../Images/SmallCalendar.png" />&nbsp; [dd/MM/yyyy]</td>
        <td align="left" valign="top" class="reportTitleIncome" style="height: 4px" colspan="2" >
            Time</td>
        <td align="left" valign="top" class="Info" style="height: 4px" >
        ...
        <td align="right" valign="top" style="height: 4px" >
            &nbsp;</td>
    </tr>   
    <tr>
        <td align="left" colspan="8" valign="top">
                            <asp:Label ID="lblCaseCount" runat="server" Font-Bold="True" Width="89%"></asp:Label>
    ...
    <table id="tblViewDetail" runat="server" cellpadding="0" cellspacing="0" border="0" style="width: 812px">
        <tr>
            <td colspan="3" style="width: 738px">
                <table id="tblCaseCount" runat="server" visible="false" width="100%" style="width: 100%; height: 100%">
                    <tr><td colspan="4" style="width: 813px">
                    <asp:HyperLink ID="hplDownload" runat="server" Target="_blank" Visible="False" Font-Bold="True" Font-Size="Small" Font-Underline="True" ForeColor="Blue">Download Reports</asp:HyperLink>
                    </td></tr>
                    <tr>
                        <td align="right" valign="top" colspan="4" class="tta">
        ...
        <asp:Button ID="btnExport1" runat="server" Text="Export" SkinID="btnexportskin" OnClick="btnExport1_Click" ValidationGroup="a"  /></td>
                    ...
                    <tr>
                        <td colspan="4" style="width: 813px">
                            &nbsp; &nbsp; &nbsp;
        <asp:GridView ID="gvOutput" runat="server" SkinID="gridviewNoSort" DataSourceID="SqlDataSourceDate" AutoGenerateColumns="False" 
        DataKeyNames="CASE_ID" OnDataBound="gvOutput_DataBound" PageSize="100" AllowPaging="True" OnPageIndexChanged="gvOutput_PageIndexChanged" OnPageIndexChanging="gvOutput_PageIndexChanging" Width="100%">
            <Columns>
                ...
                <asp:CheckBox ID="chkCaseId" runat="server" /><asp:HiddenField ID="hidCaseId" runat="server"
                    ...
                    <tr>
                        <td align="right" colspan="4" style="width: 813px" class="tta">
    ...
    <asp:Button ID="btnExport" runat="server" Text="Export" SkinID="btnexportskin" OnClick="btnExport_Click" ValidationGroup="a"  />
                    ...
                    <tr>
                        <td align="right" colspan="4" style="width: 813px">
    ...
    <asp:RegularExpressionValidator ID="revFromDate" runat="server" ControlToValidate="txtFromDate"
        ...
        <tr>
            <td class="TDWidth" colspan="3" style="height: 57px; width: 738px;">
