<%@ Page Language="C#" MasterPageFile="~/FRC/Employee Background Check/EBC_MasterPage.master" AutoEventWireup="true" CodeFile="EBC_FECaseAssignment.aspx.cs" Inherits="EBC_New_EBC_New_EBC_FECaseAssignment" Title="EBC Fe Assignment" %>
    ...
    <table>
        ...
        <tr>
            <td class="topbar" colspan="8" style="height: 28px">
                &nbsp;Field Executive Case&nbsp; Assignment Tray</td>
        </tr>
        <tr>
            <td style="width: 10px">
            </td>
        ...
        <tr>
            ...
            <td class="Info" style="width: 100px; color: #ff0000">
                <asp:DropDownList ID="ddlSubVeriType" runat="server" SkinID="ddlSkin">
        ...
        <tr>
            <td class="tta" colspan="8">
                ...
                <asp:Button ID="btnReset" runat="server" OnClick="btnSearch_Click" Text="Reset" Font-Bold="True" /></td>
        </tr>
        <tr>
            <td colspan="8">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 338px">
                    <tr>
                        <td style="height: 20px">
                            &nbsp;<asp:Label ID="Label1" runat="server" Text="Field Executive Name" Width="131px"></asp:Label></td>
                        <td style="height: 20px">
