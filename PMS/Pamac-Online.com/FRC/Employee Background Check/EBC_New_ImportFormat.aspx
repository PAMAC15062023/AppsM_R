<%@ Page Language="C#" MasterPageFile="~/FRC/Employee Background Check/EBC_MasterPage.master" AutoEventWireup="true" CodeFile="EBC_New_ImportFormat.aspx.cs" Inherits="EBC_New_EBC_New_EBC_New_ImportFormat" StylesheetTheme="SkinFile" Title="Import Format" %>
    ...
    <table>
        ...
        <tr>
            <td class="tta" colspan="9" style="height: 17px">
                &nbsp;EBC Standard Import Excel File</td>
        </tr>
        <tr>
            <td style="width: 2px">
                &nbsp;
            ...
            <td class="reportTitleIncome" style="width: 194px">
                &nbsp;Import File (.xls)</td>
            <td colspan="5">
                <asp:FileUpload ID="FileUpload_Xls" runat="server" SkinID="flup" TabIndex="1" Width="469px" /></td>
        ...
        <tr>
            <td class="tta" colspan="9" style="height: 25px">
                ...
                <asp:Button ID="btnCancel" runat="server" Text="Cancel" SkinID="btn" TabIndex="5" /></td>
        </tr>
        <tr>
