<%@ Page Language="C#" MasterPageFile="~/CPA/PDNEW/CPA_MasterPage.master" AutoEventWireup="true" CodeFile="CPA_SendToHO.aspx.cs" Inherits="CPA_CPA_SendToHO" Title="SendToHO" Theme="skinFile" StylesheetTheme="SkinFile" %>
...
<td class="Info" style="width: 280px" colspan=""><asp:TextBox id="txtfromdate" runat="server" MaxLength="10" SkinID="txtSkin"></asp:TextBox>
...
<td class="reportTitleIncome" style="height: 36px">To Date:* </td>
<td class="Info" style="height: 36px"><asp:TextBox id="txtToDate" runat="server" MaxLength="10" SkinID="txtSkin"></asp:TextBox>
...
<td colspan="6">
    ...
    <td class="Info"><asp:TextBox id="txtSendDt" ReadOnly="true" runat="server" ValidationGroup="grpSend" MaxLength="10" SkinID="txtSkin"  CssClass="textbox">04/08/2012</asp:TextBox>&nbsp;
    ...
    <td align="right"  id="TD1" runat="server">
       ...
       <%-- <tr runat="server">
            <td class="reportTitleIncome" style="width: 612px">
                PO No : *</td>
            <td class="Info">
        <asp:TextBox ID="txtPONO" runat="server" SkinID="txtSkin"></asp:TextBox></td>
            <td class="reportTitleIncome" style="width: 1215px">
            </td>
            <td class="Info" style="width: 225px">
            </td>
            <td align="right">
...
<asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="List" ShowMessageBox="True" 
    ShowSummary="False" ValidationGroup="grpSearch" />
        <%--<asp:RequiredFieldValidator ID="reqPONO" runat="server" ControlToValidate="txtPONO"
            Display="None" ErrorMessage="Please enter PO No for Selected Cases." SetFocusOnError="True"
            ValidationGroup="grpSend"></asp:RequiredFieldValidator>--%>
    ...
    <td style="height: 42px; width: 75px;" >
    </td>
</tr>
    <tr>
        <td style="width: 37px" >
