<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" AutoEventWireup="true" Theme="SkinFile" CodeFile="RL_BusinessTelephonicVerification.aspx.cs" Inherits="CPV_RL_RL_BusinessTelephonicVerification"  StylesheetTheme="SkinFile" %>
...
<asp:Panel ID="pnlOfficeTelephoneNo" runat="server" Width="100%" Visible="true" >
...
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin"   ID="txtOfficeTelephoneNo" runat="server" MaxLength="100"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin"   ID="txtExactCompanyName" runat="server" MaxLength="100" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin"   ID="txtExactCompanyAddress" runat="server" MaxLength="100" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin"   ID="Label3" runat="server" Text="Mailing Address"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin"   ID="txtMailAdd" runat="server" MaxLength="100"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin"   ID="lblNoofyrswiththeCompany" runat="server" Text="No. of yrs with the Prev Company"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin"   ID="Label2" runat="server" Text="Applicant Age"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin" ID="txtAppAge" runat="server" MaxLength="100"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin"   ID="txtOfficeOrBusinessAddressasperCall" runat="server" MaxLength="500" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<asp:Label SkinID="lblSkin"  ID="Label16" runat="server" Text="Rating" ></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin"   ID="lblProvidereasonforunsatisfactoryrating" runat="server" Text="Please provide reason for unsatisfactory/recommended rating "></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="lblExtNo" runat="server" Text="Ext. No./Mobile"></asp:Label>
</td>
<td style="width:2%">:</td>
<td>
<asp:TextBox SkinID="txtSkin"    ID="txtExtNo" runat="server" MaxLength="500"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="lblNoOfYearscurrEmployment" runat="server" Text="No. of Years at same address"></asp:Label>
</td>
<td style="width:2%">:</td>
<td>
<asp:TextBox SkinID="txtSkin" ID="txtNoOfYearsAtSameAddress" runat="server" MaxLength="50"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="lblLandmarkObserved" runat="server" Text="Landmarks"></asp:Label>
</td>
<td style="width:2%">:</td>
<td>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label4" runat="server" Text="Income Docs submitted with application "></asp:Label>
</td>
<td style="width:2%">:</td>
<td>
<asp:TextBox SkinID="txtSkin" ID="txtIncomeDoc" runat="server"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>

<asp:Panel ID="pnlTotalExperience" runat="server" Width="100%" Visible="false">
<table id="Table1" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="lblTotalExperience" runat="server" Text="Total Experience"></asp:Label>
</td>
<td style="width:2%">:</td>
<td>
<asp:TextBox SkinID="txtSkin" ID="txtTotalExperience" runat="server" MaxLength="50"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>

<asp:Panel ID="pnlNoOfEmployees" runat="server" Width="100%" Visible="false">
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="lblEmployersName" runat="server" Text="Employers Name / ID"></asp:Label>
</td>
<td style="width:2%">:</td>
<td>
<asp:TextBox SkinID="txtSkin" ID="txtEmployersName" runat="server" MaxLength="500"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="lblDirectoryCheck" runat="server" Text="Directory Check / Emp code / EMP ID"></asp:Label>
</td>
<td style="width:2%">:</td>
<td>
...
<asp:Panel ID="PnlCityStability" runat="server" Width="100%" Visible="false">
<table id="Table6" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label5" runat="server" Text="City Stability"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin" ID="txtCityStability" runat="server" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>

<asp:Panel ID="PnlExistingcarownedbyClient" runat="server" Width="100%" Visible="false">
<table id="Table7" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label8" runat="server" Text="Existing car owned by Client :"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin" ID="txtExistingcarownedbyClient" runat="server" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>

<asp:Panel ID="PnlFinanced" runat="server" Width="100%" Visible="false">
<table id="Table10" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label9" runat="server" Text="Financed :"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin" ID="txtFinanced" runat="server" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>

<asp:Panel ID="Pnlloannoifreqd" runat="server" Width="100%" Visible="false">
<table id="Table11" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label10" runat="server" Text="loan no if reqd :"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin" ID="txtloannoifreqd" runat="server" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label11" runat="server" Text="Loan Amount:"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin" ID="txtLoanAmount" runat="server" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin"   ID="Label15" runat="server" Text="Purpose Of Loan Taken:"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
...
<table id="Table15" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin"   ID="Label14" runat="server" Text="Profile:"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:DropDownList ID="ddlProfileConfIssu" runat="server"  AutoPostBack="false" SkinID="ddlSkin">    
        <asp:ListItem Text="NA" Value=""></asp:ListItem>
        <asp:ListItem>Salaried</asp:ListItem>
        <asp:ListItem>SENP</asp:ListItem>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label12" runat="server" Text="Rent Amount (If rented):"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label13" runat="server" Text="Total Turnover:"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
<asp:TextBox SkinID="txtSkin" ID="txtTurnOver" runat="server" Width="60%"></asp:TextBox>
</td>
</tr>
</table>
</asp:Panel>

<%--Ended by Manoj for...YesbankautoLoan--%>
<%--Sabbani Naresh End 17/06/08--%>
...
<asp:Panel ID="pnlTeleWhoseName" runat="server" Width="100%" Visible="false">
    <table id="Table20" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
        <tr>
            ...
            <td style="width:2%">:</td>
            <td >
                <asp:TextBox SkinID="txtSkin" ID="txtTeleWhoseName" runat="server" Width="80%"></asp:TextBox>
            </td>
        </tr>
    </table>
</asp:Panel>
...
<asp:Panel ID="pnlAdderssCDROM" runat="server" Width="100%" Visible="false">
    <table id="Table21" cellpadding="0" cellspacing="0" style="width: 100%" runat="server">
        <tr>
            ...
            <td style="width:2%">:</td>
            <td >
                <asp:TextBox SkinID="txtSkin" ID="txtAdderssCDROM" runat="server" Width="80%"></asp:TextBox>
            </td>
        </tr>
    </table>
</asp:Panel>
...
<tr>
<td class="TDWidth">
<asp:Label SkinID="lblSkin" ID="Label17" runat="server" Text="Reason for Decline / Refer"></asp:Label>
</td>
<td style="width:2%">:</td>
<td >
