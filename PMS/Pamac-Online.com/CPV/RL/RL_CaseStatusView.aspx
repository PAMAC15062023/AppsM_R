...
<td>
    <asp:GridView ID="gvCaseStatusView" SkinID="gridviewSkin" runat="server" Width="99%" AutoGenerateColumns="False" OnRowCommand="gvCaseStatusView_RowCommand" OnRowCreated="gvCaseStatusView_RowCreated" OnRowDataBound="gvCaseStatusView_RowDataBound" AllowPaging="True" OnPageIndexChanging="gvCaseStatusView_PageIndexChanging">
        <Columns>
            ...
            <asp:BoundField HeaderText="Applicant Type" DataField="App_Type" />
            <asp:TemplateField HeaderText="Select Verification Type">
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblITVR" runat="server" Text="ITVR" Visible="false" />
                    <asp:Label ID="lblSlashITVR" runat="server" Width="9px" Visible="False" ForeColor="Blue">/</asp:Label>
                    ...
                    <asp:Label ID="lblBS" runat="server" Text="BS" Visible="false" />
                    <asp:Label ID="lblSlashBS" runat="server" Width="9px" Visible="False" ForeColor="Blue">/</asp:Label>
