...
<tr><td style="padding-left:10px">
    ...
    <%--   ended by abhijeet--%>
                             ...
                             <!---added by kamal matekar----for federal finance--->
                               ...
                               <%--added by nikhil for HDFC ltd. Vendor 24 Sept 2013--%>
                               <asp:Panel ID="pnlDocuments" runat="server" Width="100%" Visible="false">
                                    <table cellpadding="0" cellspacing="0" border="0" id="tblDocuments" style="width:100%" runat="server">
                                        <tr>         
                                        <td class="TDWidth">
                                            <asp:Label SkinID="lblSkin" ID="lblDocuments" runat="server" Text="Document Checked "></asp:Label>
                                        </td><td style="width:2%">:</td>
                                        <td >
                                           <asp:TextBox SkinID="txtSkin" MaxLength="255" Width="80%" ID="txtDocuments" runat="server" ></asp:TextBox> 
                                        </td>
                                        </tr>
                                   </table>
                               </asp:Panel>
                               
                               <asp:Panel ID="pnlDocumentNo" runat="server" Width="100%" Visible="false">
                                    <table cellpadding="0" cellspacing="0" border="0" id="tblDocumentNo" style="width:100%" runat="server">
                                        <tr>         
                                        <td class="TDWidth">
                                            <asp:Label SkinID="lblSkin" ID="lblDocumentNo" runat="server" Text="Document No. "></asp:Label>
                                        </td><td style="width:2%">:</td>
                                        <td >
                                           <asp:TextBox SkinID="txtSkin" MaxLength="255" Width="80%" ID="txtDocumentNo" runat="server" ></asp:TextBox> 
                                        </td>
                                        </tr>
                                   </table>
                               </asp:Panel>
                               
                               <%--end by nikhil for HDFC ltd. Vendor 24 Sept 2013--%>
        ...
        <asp:SqlDataSource ID="sdsFE" runat="server" 
            ...
            SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    <asp:SqlDataSource ID="sdsCaseStatus" runat="server" 
                          ProviderName="System.Data.OleDb" SelectCommand="SELECT [CASE_STATUS_ID], [STATUS_CODE] FROM [CASE_STATUS_MASTER] WHERE ([PRODUCT_ID] = ?) ORDER BY STATUS_CODE">
                          <SelectParameters>
