...
<tr>
    <td colspan="6">
        &nbsp;<asp:SqlDataSource ID="sdsVeriType" runat="server" 
            ProviderName="System.Data.OleDb" SelectCommand="SELECT VERIFICATION_TYPE_ID, VERIFICATION_TYPE_CODE FROM VERIFICATION_TYPE_MASTER WHERE (ACTIVITY_ID = '1011') and VERIFICATION_TYPE_ID IN(1,2,10,14) ">
        </asp:SqlDataSource>
    </td>
</tr>
