<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" AutoEventWireup="true" CodeFile="RL_QC_CASE_Allotment.aspx.cs" Inherits="CPV_RL_RL_QC_CASE_Allotment" Title="PAMAC Online Service" %>
...
// ]]>
        ...
        &nbsp<table cellpadding="1" cellspacing="0">
                ...
                <tr>
                    <td colspan="7">
                        <asp:Panel ID="Panel2" runat="server" Height="200px" ScrollBars="Both" Width="958px">
                        <asp:GridView ID="gvQC" runat="server" Width="914px" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnDataBound="gvQC_DataBound" Font-Names="Tahoma" Font-Size="8pt" SkinID="gridviewSkin">
