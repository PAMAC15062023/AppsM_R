<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" AutoEventWireup="true" CodeFile="RL_StandardOutput.aspx.cs" Inherits="RL_RL_StandardOutput" Theme="SkinFile"%>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
    ...
    <tr><td align="right">
        ...
        <asp:Button ID="btnExcelReport1" runat="server" Text="Generate Report" OnClick="btnExcelReport_Click"  /></td></tr>
    <tr><td>
    ...
    <asp:Button ID="btnExcelReport" runat="server" Text="Generate Report" OnClick="btnExcelReport_Click"/></td></tr>
