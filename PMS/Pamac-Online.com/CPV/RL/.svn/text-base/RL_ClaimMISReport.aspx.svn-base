<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" Theme="SkinFile"  AutoEventWireup="true" CodeFile="RL_ClaimMISReport.aspx.cs" Inherits="CPV_RL_RL_ClaimMISReport" Title="Untitled Page" %>
...
<table id="tblGenerateReport" runat="server" style="width:100%;" >
    ...
    <td><asp:Button ID="btnGenrateReport" runat="server" OnClientClick="javascript:return ValidateDate();" Text="Generate Report" OnClick="btnGenrateReport_Click" SkinID="btnReportSkin" />
    </td>
    </tr>
    <tr align="center">
    <td>
