<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" AutoEventWireup="true" Theme="SkinFile" CodeFile="RL_REF2Verification.aspx.cs" Inherits="CPV_RL_RL_REF2Verification" %>
<asp:Content ID="Content1" ContentPlaceHolderID="C1" Runat="Server">
<table border="0" cellpadding="0" cellspacing="0" width="99%">
<tr><td style="padding-left:10px">
<fieldset><legend class="FormHeading">REF 2 VERIFICATION REPORT</legend>
<table id="tblMain" runat="server" width="100%" cellpadding="0" cellspacing="0" style="background-color:#E7F6FF">
<tr><td></td><td></td><td></td></tr>
<tr><td></td><td>
 <!--Start Heading-->
<asp:Panel ID="pnlRef2VerHead" runat="server" Width="100%" Visible="false">
<table>
<tr>
<td class="txtBold" style="background-color:#D0D5D8; height: 16px; width:5%" align="center">
<asp:Label SkinID="lblSkin"   ID="lblRef2VerificationReport" runat="server" Text="REF 2 VERIFICATION REPORT"></asp:Label>
 </td>
 </tr>
 </table>
 </asp:Panel>
...
<asp:Table ID="tblRef2Veri" runat="server"  Width="100%">
...
<asp:Panel ID ="pnlDateRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID ="pnlAreaRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID ="pnlRefNoRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID ="pnlNameoftheApplicantRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlResidenceAddressofApplicantRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlResidenceAddressasperApplicationRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlNameoftheReferencepersonContactedRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlRelationshipofReferencewithApplicantRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlApplicantKnowSinceMMAndYYbytheReferenceRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlPhoneNumberoftheReferenceRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlRefContactedConfirmsAppStayGivenAddressRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlReferenceResidenceAddressasperCallRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlNumberofYearsatResidenceRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlOccupationTypeRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlNameofEmpOrNatureBusinessRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlDesignationoftheApplicantRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlMTNLCheckRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlPurposeRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlAddressDifferentRef2" runat="server" Width="100%" Visible="false">
...
<asp:Panel ID="pnlSubmitRef2" runat="server" Width="100%"  Visible="True">
