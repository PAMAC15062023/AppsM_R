<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" AutoEventWireup="true" Theme="SkinFile" CodeFile="RL_ResidenceTelephonicVerification.aspx.cs" Inherits="CPV_RL_RL_ResidenceTelephonicVerification"  %>
