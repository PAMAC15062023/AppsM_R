<%@ Page Language="C#" MasterPageFile="~/CPV/RL/RL_MasterPage.master" AutoEventWireup="true" CodeFile="RL_FEAutoAssignment.aspx.cs" Inherits="CPV_RL_RL_FEAutoAssignment" Theme="SkinFile"%>
...
<tr>
    <td colspan="6">
        &nbsp;<asp:SqlDataSource ID="sdsVeriType" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"
            ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>" SelectCommand="SELECT VERIFICATION_TYPE_ID, VERIFICATION_TYPE_CODE FROM VERIFICATION_TYPE_MASTER WHERE (ACTIVITY_ID = '1011') and VERIFICATION_TYPE_ID IN(1,2,10,14) ">
        </asp:SqlDataSource>
    </td>
</tr>
