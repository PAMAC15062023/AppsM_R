<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile= "~/CPV/RL/RL_MasterPage.master" Theme="SkinFile" CodeFile="RL_FEAssignmentTracking.aspx.cs" Inherits="CPV_RL_RL_FEAssignmentTracking" %>
 ...
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <asp:ValidationSummary ID="ValidationSummary2" runat="server" DisplayMode="List"
     ...
     SelectCommand="Select [VERIFICATION_TYPE_ID], [VERIFICATION_TYPE_CODE] from VERIFICATION_TYPE_MASTER 
               WHERE VERIFICATION_TYPE_ID IN(1,2,3,4,10,12,13,14) "></asp:SqlDataSource>
