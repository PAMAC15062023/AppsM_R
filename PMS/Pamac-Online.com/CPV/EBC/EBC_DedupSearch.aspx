<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPV/EBC/EBC_MasterPage.master" CodeFile="EBC_DedupSearch.aspx.cs" Inherits="EBC_DedupSearch" Theme="SkinFile" %>
      ...
      <table Width="100%" Align="Centre">
          <tr>
              ...
              <td style="width: 246px" >
                      <asp:TextBox ID="txtDate" runat="server" SkinID="txtSkin"></asp:TextBox>&nbsp;<img alt="" onclick="popUpCalendar(this, document.all.<%=txtDate.ClientID%>, 'dd/mm/yyyy', 0, 0);"
