...
<fieldset><legend class="FormHeading">FE Assignment</legend>
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <asp:ValidationSummary ID="ValidationSummary2" runat="server" DisplayMode="List"
     ...
     <asp:SqlDataSource ID="sdsVeriType" runat="server"  ProviderName="System.Data.OleDb"  SelectCommand="Select [VERIFICATION_TYPE_ID], [VERIFICATION_TYPE_CODE] from VERIFICATION_TYPE_MASTER &#13;&#10;               WHERE VERIFICATION_TYPE_ID IN(1,2,15,16,17,18) AND (PARENT_TYPE_CODE = 'VV')"></asp:SqlDataSource>
