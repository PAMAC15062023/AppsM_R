<%@ Page Language="C#" MasterPageFile="~/CPV/EBC/EBC_MasterPage.master" AutoEventWireup="true" CodeFile="EBC_Cover_Letter.aspx.cs" Inherits="CPV_EBC_EBC_Cover_Letter" Theme="SkinFile"%>
...
<fieldset><legend class="FormHeading">Covering Letter</legend>
        <table align="center" width="100%">
            ...
            <tr>
                ...
                <td style="height: 40px">
                    <asp:SqlDataSource ID="sdsddlVeriType" runat="server"  ProviderName="System.Data.OleDb" SelectCommand="SELECT VERIFICATION_TYPE,VERIFICATION_TYPE_ID, VERIFICATION_TYPE_CODE FROM VERIFICATION_TYPE_MASTER WHERE (VERIFICATION_TYPE_ID IN (1,15,16,17,18)) AND (PARENT_TYPE_CODE = 'VV') order by  VERIFICATION_TYPE"></asp:SqlDataSource>
                </td>
                <td style="height: 40px">
                </td>
            </tr>
