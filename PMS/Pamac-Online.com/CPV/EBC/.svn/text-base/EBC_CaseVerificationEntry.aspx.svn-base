<%@ Page Language="C#" MasterPageFile="~/CPV/EBC/EBC_MasterPage.master" AutoEventWireup="true" CodeFile="EBC_CaseVerificationEntry.aspx.cs" Inherits="EBC_EBC_CaseVerificationEntry"%>
<asp:Content ID="Content1" ContentPlaceHolderID="C1" Runat="Server">
<script language="javascript" src="../../CommonJFunction.js" type="text/javascript"> </script>
...
<table style="width: 100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <tr><td align="center"><b>EBC Case Verification Detail</b></td></tr>
                            <tr>
                                <td>
                            ...
                            <td style="width: 8%">Address Confirm</td>
                            <td style="width: 18%">Confirm From</td>
                            <td style="width: 18%">Third Party confirms</td>                            
                            </tr>
                            <tr>
                            <td >Attempt1</td>
                            ...
                            <td><asp:TextBox ID="txtAttemptRemark1" runat="server" MaxLength="255" TextMode="MultiLine" Width="206px"></asp:TextBox></td>
                            <td align="center">
                                <asp:CheckBox ID="chkAddress1" runat="server" /></td>
                            <td ><asp:TextBox ID="txtConfirmFrom1" runat="server" MaxLength="100"></asp:TextBox></td>
                            <td ><asp:TextBox ID="txtThirdParty1" runat="server" MaxLength="100"></asp:TextBox>
                           ...
                           <asp:CustomValidator ID="cvAttemptRemark1" runat="server" ClientValidationFunction="ValidateRemark1"
                            ...
                            <td><asp:TextBox ID="txtAttemptRemark2" runat="server" MaxLength="255" TextMode="MultiLine" Width="206px"></asp:TextBox></td>
                            <td align="center">
                                <asp:CheckBox ID="chkAddress2" runat="server" /></td>
                            <td><asp:TextBox ID="txtConfirmFrom2" runat="server" MaxLength="100"></asp:TextBox></td>
                            <td><asp:TextBox ID="txtThirdParty2" runat="server" MaxLength="100"></asp:TextBox>
                            <asp:CustomValidator ID="cvAttemptTime2" runat="server" ControlToValidate="txtAttemptTime2"
                                 Display="None" ErrorMessage="Enter remark in second attempt." 
                                 ValidationGroup="grpValidate" ClientValidationFunction="ValidateTime2"></asp:CustomValidator>
                           <asp:CustomValidator ID="cvAttemptRemark2" runat="server" ClientValidationFunction="ValidateRemark2"
                            ...
                            <td><asp:TextBox ID="txtAttemptRemark3" runat="server" MaxLength="255" TextMode="MultiLine" Width="206px"></asp:TextBox></td>
                            <td align="center">
                                <asp:CheckBox ID="chkAddress3" runat="server" /></td>
                            <td><asp:TextBox ID="txtConfirmFrom3" runat="server" MaxLength="100"></asp:TextBox></td>
                            <td><asp:TextBox ID="txtThirdParty3" runat="server" MaxLength="100"></asp:TextBox>
                            <asp:CustomValidator ID="cvAttemptTime3" runat="server" ControlToValidate="txtAttemptTime3"
                                 Display="None" ErrorMessage="Enter remark in third attempt." 
                                 ValidationGroup="grpValidate" ClientValidationFunction="ValidateTime3"></asp:CustomValidator>
          ...
          <td>
                ...
                <tr>
                    ...
                    <asp:SqlDataSource ID="sdsVerification" runat="server" ProviderName="System.Data.OleDb"
                     ...
                     SelectCommand="select verification_type_Id,verification_type from verification_type_master where verification_type_code in('RV','BV','RT','BT')"                     
                     ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"></asp:SqlDataSource>
