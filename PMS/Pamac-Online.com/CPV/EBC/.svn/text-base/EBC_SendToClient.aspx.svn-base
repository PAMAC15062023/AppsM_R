<%@ Page Language="C#" MasterPageFile="~/CPV/EBC/EBC_MasterPage.master" Theme="SkinFile" AutoEventWireup="true" CodeFile="EBC_SendToClient.aspx.cs" Inherits="CPV_EBC_EBC_SendToClient"  %>
            ...
            <tr>
              ...
              <tr>
                <td class="label">From Date:<span class="txtRed">* </span></td>
                   ...
                   <td><asp:TextBox ID="txtfromdate" SkinID="txtSkin" runat="server" MaxLength="10" ></asp:TextBox>
                      </td>
               ...
               <td>
                ...
                <td><asp:Button ID="BtnSearch" runat="server"  SkinID="btnSearchSkin"  OnClick="BtnSearch_Click" OnClientClick="javascript:return ValidateDate();"  Text="Search"  /></td>
          ...
          <tr>
                <td colspan="9"  > 
                    <asp:GridView ID="gvSearch" runat="server"  SkinID="gridviewSkin" AutoGenerateColumns="False"  >
                        <Columns>
                            <asp:BoundField DataField="Ref_no"  HtmlEncode="False"  SortExpression="Ref_no"  HeaderText="Ref_no" />
                            <asp:BoundField DataField="Applicant_name"   HtmlEncode="False"  SortExpression="Applicant_name"   HeaderText="Applicant Name" />
                            <asp:BoundField DataField="Rec_date"  HtmlEncode="False"  SortExpression="Rec_date"  HeaderText="Rec Date" />
                    ...
                    <asp:GridView ID="gvSendTat" runat="server" SkinID="gridviewSkin"   AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="CaseId" HtmlEncode="False"  SortExpression="CaseId"   HeaderText="CaseId" />
                            <asp:BoundField DataField="REF_NO" HtmlEncode="False"  SortExpression="REF_NO"  HeaderText="REF_NO" />
                            <asp:BoundField DataField="APPLICANT_NAME" HtmlEncode="False"  SortExpression="APPLICANT_NAME"  HeaderText="APPLICANT_NAME" />
                            <asp:BoundField DataField="REC_DATE"  HtmlEncode="False"  SortExpression="REC_DATE" HeaderText="REC_DATE" />
                            <asp:BoundField DataField="TAT_HRS"   HtmlEncode="False"  SortExpression="TAT_HRS"   HeaderText="TAT_HRS" />
