<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" Theme="SkinFile" CodeFile="KYC_Import.aspx.cs" Inherits="CPV_KYC_KYC_Import" %>
...
<table align="center"  border="0" cellpadding="2" cellspacing="1"
    ...
    <tr valign="top">
        ...
        <td align="left">
             <asp:DropDownList ID="ddlVeriType" runat="server" SkinID="ddlSkin" DataSourceID="sdsVeriType" DataValueField="VERIFICATION_TYPE_ID" DataTextField="VERIFICATION_TYPE_CODE" OnDataBound="ddlVeriType_DataBound">
            </asp:DropDownList>
            <asp:SqlDataSource ID="sdsVeriType" runat="server" SelectCommand="Select [VERIFICATION_TYPE_ID], [VERIFICATION_TYPE_CODE] from VERIFICATION_TYPE_MASTER 
               WHERE VERIFICATION_TYPE_ID IN(1,2,19) AND (PARENT_TYPE_CODE = 'VV')" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>" ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>"></asp:SqlDataSource>
