<%@ Page Language="C#" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" Theme="SkinFile" AutoEventWireup="true" CodeFile="KYC_SearchSms.aspx.cs" Inherits="CPV_KYC_KYC_SearchSms" %>
