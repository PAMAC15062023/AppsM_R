<%@ Page Language="C#" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" Theme="skinFile"  AutoEventWireup="true" CodeFile="KYC_CaseStatusView.aspx.cs" Inherits="CPV_KYC_KYC_CaseStatusView"  %>
