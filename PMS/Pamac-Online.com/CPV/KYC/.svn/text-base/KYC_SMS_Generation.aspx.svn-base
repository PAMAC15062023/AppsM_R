<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" Theme="SkinFile" CodeFile="KYC_SMS_Generation.aspx.cs" Inherits="CPV_KYC_KYC_SMS_Generation" %>
