<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" Theme="SkinFile"   CodeFile="KYC_FEAssignment.aspx.cs" Inherits="CPV_KYC_KYC_FEAssignment" %>
 ...
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <tr>
        ...
        <td >FE Name<span style="color:Red;">*</span></td><td style="width: 2px">:</td><td>
            <asp:DropDownList ID="ddlFE" runat="server" OnDataBound="ddlFE_DataBound" DataSourceID="sdsFE" DataTextField="FULLNAME" DataValueField="FE_ID" SkinID="ddlSkin" ValidationGroup="vgrpFE">
            </asp:DropDownList></td>   
