<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" Theme="SkinFile"  CodeFile="KYC_FEAssignmentTracking.aspx.cs" Inherits="CPV_KYC_KYC_FEAssignmentTracking" %>
 ...
 <table border="0" cellpadding="1" cellspacing="0" width="100%">   
    ...
    <asp:ValidationSummary ID="ValidationSummary2" runat="server" DisplayMode="List"
     ...
     SelectCommand="Select [VERIFICATION_TYPE_ID], [VERIFICATION_TYPE_CODE] from VERIFICATION_TYPE_MASTER 
               WHERE VERIFICATION_TYPE_ID IN(1) AND (PARENT_TYPE_CODE = 'VV')"></asp:SqlDataSource>
