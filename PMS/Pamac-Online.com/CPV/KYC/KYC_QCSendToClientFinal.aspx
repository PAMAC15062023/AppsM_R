<%@ Page Language="C#" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" AutoEventWireup="true" CodeFile="KYC_QCSendToClientFinal.aspx.cs" Inherits="CPV_KYC_KYC_QCSendToClientFinal" Theme="SkinFile"%>
...
<td colspan="5">
    ...
    <td style="height: 26px"><asp:TextBox id="txtSendDt" runat="server" ValidationGroup="grpSend" MaxLength="10" SkinID="txtSkin"  CssClass="textbox"></asp:TextBox>&nbsp;
