<%@ Page Language="C#" MasterPageFile="~/CPV/KYC/KYC_MasterPage.master" AutoEventWireup="true" CodeFile="KYC_EXPORT_ALL.aspx.cs" Inherits="CPV_KYC_KYC_EXPORT_ALL" Theme="SkinFile" %>
...
<table id="tblExport" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <img alt="Calendar" onclick="popUpCalendar(this, document.all.ctl00$C1$txtToDate, 'dd/mm/yyyy', 0, 0);"
        ...
        <td align="left" valign="top">
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="HDFC Excel Report" SkinID="btn" ValidationGroup="vgrpExcelReport" />
            <asp:Button ID="btnHDFC_Ergo_Excel" runat="server" OnClick="btnHDFC_Ergo_Excel_Click"
                SkinID="btn"  ValidationGroup="vgrpExcelReport"  Text="HDFC ERGO Excel Report" />
            <asp:Button ID="btnHDFC_OneTime" runat="server" OnClick="btnHDFC_OneTime_Click" SkinID="btn"
                Text="HDFC One Time" ValidationGroup="vgrpExcelReport" />
            <asp:Button ID="btnPayZippy" runat="server" OnClick="btnPayZippy_Click" SkinID="btn"
                Text="PayZippy Excel Report" ValidationGroup="vgrpExcelReport" />
            <asp:Button ID="btnHDFCSales" runat="server" OnClick="btnHDFCSales_Click" Text="HDFC SALES Excel Report" SkinID="btn" ValidationGroup="vgrpExcelReport"  /></td>
        <td align="left" valign="top">
        </td>
    <td align="left">
        </td>
   ...
   <tr><td colspan="11"><hr /></td></tr>
    <tr>
        ...
        <td align="right" valign="top" >
           <asp:Button ID="btnSearch" runat="server" SkinID="btnSearchSkin"  OnClick="btnSearch_Click" />
        </td>
    </tr>   
    <tr>
    ...
    <asp:Button ID="btnExport" runat="server" Text="Export" SkinID="btnexportskin" ValidationGroup="a" OnClick="btnExport_Click"  />
                    ...
                    <tr>
                        <td align="right" colspan="4" style="height: 140px">
