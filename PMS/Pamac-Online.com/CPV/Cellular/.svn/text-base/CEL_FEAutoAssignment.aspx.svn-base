<%@ Page Language="C#" MasterPageFile="~/CPV/Cellular/CEL_MasterPage.master" AutoEventWireup="true" CodeFile="CEL_FEAutoAssignment.aspx.cs" Inherits="CPV_Cellular_CEL_FEAutoAssignment" Theme="SkinFile"%>
...
<td  >
    ...
    <tr>
        ...
        <td style="width:5px" align="center">:</td>
        <td>
            <asp:DropDownList ID="ddlCaseType" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSourceCase_Type"
                DataTextField="CASE_TYPE_CODE" DataValueField="CASE_TYPE_ID" SkinID="ddlSkin">
...
<tr>
    <td colspan="6">
        <asp:SqlDataSource ID="SqlDataSourceCase_Type" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"
            ProviderName="<%$ ConnectionStrings:CMConnectionString.ProviderName %>" SelectCommand="SELECT [CASE_TYPE_ID], [CASE_TYPE_CODE] FROM [CPV_CELLULAR_CASE_TYPE_MASTER]">
        </asp:SqlDataSource>
    </td>
</tr>
