<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CEL_SendDateNull.aspx.vb" MasterPageFile="~/CPV/CC/CC_MasterPage.master" Inherits="CPV_Cellular_CEL_SendDateNull" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 496px; left: 248px; position: relative; top: 56px; height: 128px;">
            ...
            <tr>
                <td style="width: 143px">
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Customer ID :" SkinID="lblSkin" Font-Size="Medium" Width="112px"></asp:Label>
                </td>
