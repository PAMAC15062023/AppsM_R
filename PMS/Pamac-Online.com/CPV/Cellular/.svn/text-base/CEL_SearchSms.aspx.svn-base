<%@ Page Language="C#" MasterPageFile="~/CPV/Cellular/CEL_MasterPage.master" Theme="SkinFile" AutoEventWireup="true" CodeFile="CEL_SearchSms.aspx.cs" Inherits="CPV_Cellular_CEL_SearchSms"  %>
...
<fieldset><legend class="FormHeading">Search Sms </legend>
        ...
        <table>
            ...
            <tr>
            <td colspan="3">
                <asp:Label ID="lblMessage" runat="server" ForeColor="Red" Width="501px"></asp:Label></td>
            </tr>
