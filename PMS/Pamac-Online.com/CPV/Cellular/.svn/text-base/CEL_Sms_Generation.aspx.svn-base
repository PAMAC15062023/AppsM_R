<%@ Page Language="C#" MasterPageFile="CEL_MasterPage.master" Theme="SkinFile" AutoEventWireup="true" CodeFile="CEL_Sms_Generation.aspx.cs" Inherits="CPV_Cellular_CC_Sms_Generation" Title="" %>
...
/*******************************************************
6-check Check Null Value of textbox
*********************************************************/
        ...
        <table id="tblSMSSend" width="100%">
            ...
            <tr>
                ...
                <td>
                  ...
                  <img id="Img3" alt="Calendar" onclick="popUpCalendar(this, document.all.<%=txtFromDate.ClientID%>, 'dd/mm/yyyy', 0, 0);" 
                        src="../../Images/SmallCalendar.gif" />
                    [dd/mm/yyyy]
                </td>
                <td>
                    ToDate <span style="color: #ff0000">*</span></td>
                <td>
            ...
            <tr>
                <td>
                    &nbsp;Verification type <span style="color: #ff3366">*</span>
                <td>
                    <asp:DropDownList ID="ddlVerificationId"
                    runat="server" DataSourceID="SqlDataSourceVerificationType" DataTextField="CASE_TYPE"
                    DataValueField="CASE_TYPE_ID"  SkinID="ddlSkin"  OnDataBound="ddlVerificationId_DataBound">
                </asp:DropDownList></td>
                <td>
                     </td>
                <td>
                    <asp:Button ID="brnSearch"  SkinID="btnSearchSkin" runat="server"   Text="Search" OnClick="brnSearch_Click"   OnClientClick="javascript:return ValidateDate();"  ToolTip="Click Here For Searching" ValidationGroup="verificationValidation" /></td>
            </tr>
            <tr>
                <td colspan="4">
            ...
            <tr>
                <td colspan="4">
                    <asp:Label ID="lblMessage" runat="server" Font-Bold="True" ForeColor="Red" Width="795px" Visible="False"></asp:Label></td>
            </tr>
            <tr>
                <td colspan="4">
                 <asp:GridView ID="Gview" runat="server" SkinID="gridviewSkin" Width="606px" AutoGenerateColumns="False" OnRowDataBound="Gview_RowDataBound1" PageSize="4" OnPageIndexChanging="Gview_PageIndexChanging" OnSorting="Gview_Sorting"  >
                        <Columns>
                            ...
                            <asp:BoundField DataField="CASE_REC_DATETIME"  HeaderText="Rec_Date" />
                            <asp:BoundField DataField="FullName"   HeaderText="Verifier" />
                            <asp:TemplateField HeaderText="Mobile">
                                <ItemTemplate>  
                                    <asp:TextBox ID="txtMobile"  SkinID="txtSkin" ReadOnly="true" Text='<%# Bind("MOBILE") %>'  Width="80px" runat="server" MaxLength="13"></asp:TextBox>&nbsp;
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <tr>
                <td colspan="7">
                 <asp:SqlDataSource ID="SqlDataSourceVerificationType" runat="server" ConnectionString="<%$ ConnectionStrings:CMConnectionString %>"
                    ...
                    <asp:Button ID="btnSend" runat="server" SkinID="btnSendFeSkin" OnClick="btnSend_Click"  OnClientClick="javascript:return checkSelectedRecords();"   Text="Send" Visible="False"
                        Width="90px" ValidationGroup="grp" /></td>
            </tr>
        </table>
