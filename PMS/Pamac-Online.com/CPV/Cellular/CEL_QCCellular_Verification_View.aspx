<%@ Page Language="C#" MasterPageFile="CEL_MasterPage.master" Theme="SkinFile"  AutoEventWireup="true" CodeFile="CEL_QCCellular_Verification_View.aspx.cs" Inherits="CPV_Cellular_CC_QCCELLULAR_VERIFICATION_VIEW"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="C1" Runat="Server">
<fieldset><legend  class="FormHeading">QC Cellular Verification</legend>
