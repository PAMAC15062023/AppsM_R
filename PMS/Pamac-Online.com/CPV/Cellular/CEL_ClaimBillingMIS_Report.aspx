<%@ Page Language="C#" MasterPageFile="~/CPV/Cellular/CEL_MasterPage.master" Theme="SkinFile" AutoEventWireup="true" CodeFile="CEL_ClaimBillingMIS_Report.aspx.cs" Inherits="CPV_Cellular_CEL_ClaimBillingMIS_Report"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="C1" Runat="Server">
<table border="0" cellpadding="0" cellspacing="0" width="99%">
<tr><td style="padding-left:10px">
<fieldset><legend  class="FormHeading">Claim Billing MIS Report</legend>
...
<tr>
<td colspan="5"><asp:Label ID="lblMsg" runat="server" Visible="False" ForeColor="Red"></asp:Label></td>
</tr>
<tr>
    <td colspan="5">&nbsp;</td>
</tr>
