<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CPV/CC/CC_MasterPage.master" CodeFile="CC_Import.aspx.cs" Inherits="CC_Import" Theme="SkinFile" %>
...
<script type="text/javascript" language="javascript">
   ...
   function getDisplay()
   {
        btnSub=document.getElementById("<%=btnUplaod.ClientID%>");
    ...
    <tr valign="top">
        ...
        <td align="left">
            <asp:DropDownList ID="ddlTemplate" runat="server" OnDataBound="ddlTemplate_DataBound" SkinID="ddlSkin">
                ...
                <asp:ListItem Value="1">GESBI_ImportExcel</asp:ListItem>
