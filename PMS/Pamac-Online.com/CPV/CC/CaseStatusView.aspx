<%@ Page Language="C#" MasterPageFile="~/CPV/CC/CC_MasterPage.master" AutoEventWireup="true" Theme="skinFile" CodeFile="CaseStatusView.aspx.cs" Inherits="CPV_CC_CaseStatusView" %>
...
<tr>
<td>
    <asp:GridView ID="gvCaseStatusView" SkinID="gridviewSkin" runat="server" Width="99%" AutoGenerateColumns="False" OnRowCommand="gvCaseStatusView_RowCommand" OnRowCreated="gvCaseStatusView_RowCreated" OnRowDataBound="gvCaseStatusView_RowDataBound" OnPageIndexChanging="gvCaseStatusView_PageIndexChanging">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Select Verification Type">
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblSS" runat="server" Text="SS" Visible="false" />
                    <asp:Label ID="lblSlashSS" runat="server" Width="9px" Visible="False" ForeColor="Blue">/</asp:Label>
                    
                    
                     
                     <asp:Label ID="lblMT" runat="server" Text="MT" Visible="false" />
                    <asp:Label ID="lblSlashMT" runat="server" Width="9px" Visible="False" ForeColor="Blue">/</asp:Label>
