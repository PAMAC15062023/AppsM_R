<%@ Page Language="C#" MasterPageFile="~/CPV/CC/CC_MasterPage.master" AutoEventWireup="true" CodeFile="CC_SalarySlipVerification.aspx.cs" Inherits="CPV_CC_CC_SalarySlipVerification" Title="Salary Slip Verification" %>
...
<legend class="FormHeading" style="font-size: 8pt; font-family: Arial; width: 300px;">
    ...
    <table style="background-color:#E7F6FF; width: 942px; height: 1448px; font-size: 8pt; font-family: Arial;">
      ...
      <tr>
            <td class="TDWidth" style="height: 16px">
                <strong>&nbsp;Verification Date Time :</strong></td>
            <td style="height: 16px" >
                &nbsp;<asp:TextBox ID="txtVeriDateTime" runat="server" BackColor="#FFFFC0" Width="299px"></asp:TextBox></td>
      </tr>
        <tr>
            <td class="TDWidth" style="height: 16px">
                <strong>Verifier Name :</strong></td>
            <td style="height: 16px">
                <asp:TextBox ID="txtVeriName" runat="server" BackColor="#FFFFC0" Width="299px"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="TDWidth">
                <strong>Supervisor Name :</strong></td>
            <td>
                <asp:TextBox ID="txtSuperName" runat="server" BackColor="#FFFFC0" Width="299px"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="TDWidth">
            </td>
        ...
        <tr style="font-size: 8pt; font-family: Arial">
            <td colspan="2" style="height: 12px; width: 381px;">
                <asp:Button ID="btnSave" runat="server" Text="Save" Font-Bold="True" Width="96px" BackColor="#C0C0FF" Height="33px" OnClick="btnSave_Click" />&nbsp;<asp:Button ID="btnCancle"
                    runat="server" Text="Cancle" Font-Bold="True" Width="91px" BackColor="#C0C0FF" Height="33px" OnClick="btnCancle_Click" /></td>
        </tr>
        <tr style="font-size: 8pt; font-family: Arial">
