<%@ Page Language="C#" Theme="SkinFile" MasterPageFile="~/CPV/CC/CC_MasterPage.master" AutoEventWireup="true" CodeFile="RejectCaseMIS.aspx.cs" Inherits="QueryBuilder_RejectCaseMIS" %>
...
<td style="height: 24px"  > 
    ...
    </asp:DropDownList><asp:SqlDataSource ID="sdsProduct" runat="server" 
        ProviderName="System.Data.OleDb" SelectCommand="SELECT * FROM [PRODUCT_MASTER] WHERE ([ACTIVITY_ID] IS NOT NULL)">
    </asp:SqlDataSource>
