<%@ Page Language="C#" MasterPageFile="~/CPV/CC/CC_MasterPage.master" AutoEventWireup="true"  Theme="SkinFile" CodeFile="CC_LabelPrinting.aspx.cs" Inherits="CPV_CC_CC_LabelPrinting" %>
