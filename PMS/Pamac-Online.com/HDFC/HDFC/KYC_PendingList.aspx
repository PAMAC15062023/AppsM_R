<%@ Page Language="C#" AutoEventWireup="true" Theme="SkinFile" MasterPageFile="~/HDFC/HDFC/MasterPage.master" CodeFile="KYC_PendingList.aspx.cs" Inherits="CPV_KYC_KYC_PendingList" %>
  ...
  <script language="javascript" src="../../popcalendar.js" type="text/javascript"></script>
        ...
        <table align="center" width="100%">
            <tr>
                ...
                <td><asp:Button ID="btnSearch" ValidationGroup="grValidateDate" runat="server" Text="Search" OnClick="btnSearch_Click" SkinID="btnReportSkin" Visible="False" />&nbsp;<asp:Button
                        ID="Button1" runat="server" OnClick="Button1_Click" SkinID="btn" Text=" Excel Report" /></td>
            </tr>
            <tr>
                <td colspan="7">
