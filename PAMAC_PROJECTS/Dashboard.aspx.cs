...
{
    public partial class PP_Dashboard : System.Web.UI.Page
    {
        ...
        private void Get_DataForPDF(int sid)
        {
            ...
            cmd.CommandText = "SP_gettblcasesNew";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int c = 0;  c < 6; c++)
                {
                    String colhdr = grdcases.HeaderRow.Cells[c].Text;
                    

                    for (int i = 0; i < grdcases.Rows.Count; i++)
                {

                        grdcases.Rows[i].Cells[0].Text = DateTime.Parse(grdcases.Rows[i].Cells[0].Text)
                                 .ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
                        String recdate = grdcases.Rows[i].Cells[0].Text;
                     ...
                     //   recdate = recdate.Substring(0,10);
                        ...
                        hlContro.NavigateUrl = "./Dashboard2.aspx?colname=" + colhdr + " &recdate="
                        + recdate;
