<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Pamac_Projects.PP_Dashboard" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <tr>
            <td>
                <span style="font-size: 13pt; font-weight: bold;">DASHBOARD</span>
            </td>
        </tr>
            <tr> <td> </td> </tr>
