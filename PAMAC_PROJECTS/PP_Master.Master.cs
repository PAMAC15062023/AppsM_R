...
{
    public partial class ENAM_Master : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
               ...
               string roleid = Session["Roleid"].ToString();
                ...
                if (roleid == "2")
                {
                    lnkUserMaster.Visible = true;
                    lnkDailyUpdates.Visible = false;
                }
                else
                {
                    lnkUserMaster.Visible = false;
                    lnkDailyUpdates.Visible = true;
                }
               // string activitname =  Session["ActivityName"].ToString();

                lblWelcome.Text = "PAMAC PROJECTS";
        ...
        //            //href1 = "Training_UserMaster.aspx";
        //            //href2 = "User Master";
        ...
        protected void lnkLogOut_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Session.Clear();
                    Response.Redirect("../PP_LoginPage.aspx", false);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            Response.Redirect("PP_ChangePassword.aspx", false);
        }

        protected void lnkDashboard_Click(object sender, EventArgs e)
        {
            Session["PHeader1"] = "Requirement";
            Session["PHeader2"] = "Discussions";
            Session["PHeader3"] = "Changes";
            Session["PHeader4"] = "Bugs";
            Response.Redirect("PP_Dashboard.aspx", false);
        }

        protected void lnkRequirements_Click(object sender, EventArgs e)
        {
            Session["PHeader"] = "Requirement";
        ...
        {
            Session["PHeader"] = "Discussions";
            Response.Redirect("PP_Activities.aspx", false);
        }

        protected void lnkChanges_Click(object sender, EventArgs e)
        {
            Session["PHeader"] = "Changes";
            Response.Redirect("PP_Activities.aspx", false);
        }

        protected void lnkBugs_Click(object sender, EventArgs e)
        {
            Session["PHeader"] = "Bugs";
            Response.Redirect("PP_Activities.aspx", false);
        }

        protected void lnkDailyUpdates_Click(object sender, EventArgs e)
        {
            Session["PHeader"] = "DailyUpdates";
            Response.Redirect("PP_Activities.aspx", false);
        }

        protected void lnkDocuments_Click(object sender, EventArgs e)
        {
            Session["PHeader"] = "Documents";
            Response.Redirect("PP_Activities.aspx", false);
        }
        ...
        protected void lnkUserMaster_Click(object sender, EventArgs e)
        {
            ...
            Session["PHeader"] = "UserMaster";

            Response.Redirect("PP_UserMaster.aspx", false);
