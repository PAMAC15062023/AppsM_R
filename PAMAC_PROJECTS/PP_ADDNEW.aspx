<%@ Page Title="" Language="C#" MasterPageFile="~/PP_Master.Master" AutoEventWireup="true" CodeBehind="PP_ADDNEW.aspx.cs" Inherits="Pamac_Projects.PP_ADDNEW" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <tr>
            ...
            <td class="TableHeader" colspan="5">
                ...
                <tr>
                    ...
                    <td class="TableTitle" style="height: 27px" colspan="8">
                        <asp:DropDownList ID="ddlAssignedTo" runat="server" Width="478px" AutoPostBack="true"
                            OnSelectedIndexChanged="ddlAssignedTo_SelectedIndexChanged1">
                        </asp:DropDownList>
                    </td>
                </tr>
                  <tr>
               ...
               <tr>
                    <td class="TableTitle" style="height: 27px; width: 268435392px;" colspan="8">
                        <asp:Label runat="server" Width="150px" Font-Size="10" Height="20" Style="text-align: center;">Priority</asp:Label>
                    </td>
                    <td class="TableTitle" style="height: 27px" colspan="8">
                        <asp:DropDownList ID="ddlPriority" runat="server" Width="478px" AutoPostBack="true"
            ...
            <table>
                  <tr>
                    <td class="TableTitle" style="height: 170px" >
                        <asp:TextBox ID="TxtSummary" Width="965px" runat="server" Enabled="True" Height="170px" Font-Names="Arial" Font-Size="Medium" TextMode="MultiLine"></asp:TextBox>
