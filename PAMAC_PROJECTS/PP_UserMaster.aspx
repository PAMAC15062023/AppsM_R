<%@ Page Title="" Language="C#" MasterPageFile="~/PP_Master.Master" AutoEventWireup="true" CodeBehind="PP_UserMaster.aspx.cs" Inherits="Pamac_Projects.PP_UserMaster" %>
     ...
     <table border="0" cellpadding="2" cellspacing="2">
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:TextBox ID="txtLoginName" runat="server" BorderWidth="1px" MaxLength="7" OnTextChanged="txtLoginName_TextChanged" AutoPostBack="true"></asp:TextBox></td>
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:TextBox ID="txtUserName" runat="server" BorderWidth="1px" MaxLength="50" ></asp:TextBox></td>
            <td style="width: 100px"></td>
            <td style="width: 100px"></td>
            <td style="width: 100px"></td>
        </tr>
        <tr>
            ...
            <td style="width: 100px; height: 26px">
                <asp:TextBox ID="txtPassword" runat="server" BorderWidth="1px" MaxLength="100" ReadOnly="True"></asp:TextBox></td>
            <td style="width: 100px; height: 26px">
                <asp:LinkButton ID="lnkAutoGenerate" runat="server" ToolTip="Click to Auto Generate" OnClick="lnkAutoGenetae_Click"> Auto Generate</asp:LinkButton></td>
        ...
        <tr>
            ...
            <td style="width: 100px; height: 22px;">
                <asp:DropDownList ID="ddlIsActive" runat="server" CssClass="dropdown"  Width="170px">
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:DropDownList ID="ddlRoleId" runat="server" CssClass="dropdown"  Width="170px">
                </asp:DropDownList></td>
            <td style="width: 100px"></td>
            <td style="width: 100px"></td>
            <td style="width: 100px"></td>
        ...
        <tr>
            <td class="TableHeader" colspan="5">&nbsp;&nbsp;<asp:Button ID="btnSave" runat="server" Text="Save"
              Width="67px" Font-Bold="False" OnClick="btnSave_Click"/>&nbsp;
                <asp:Button ID="btnAddNew" runat="server" Text="Add New" OnClick="btnAddNew_Click"
                    Width="67px" Font-Bold="False" />&nbsp;
