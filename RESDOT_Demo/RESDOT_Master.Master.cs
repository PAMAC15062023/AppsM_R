...
namespace RESDOT
{
    public partial class RESDOT_Master : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lblUserName.Text = "UserName : "+ username  + "- Role Name : "+ Rolename + "- Activity name: " + activityname;
        ...
        protected void lnkLogOut_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Session.Clear();
                    //Response.Redirect("../Test_LoginPage.aspx", false);
                    Response.Redirect("RESDOT_Login.aspx", false);
                }
            }
            catch (Exception ex)
