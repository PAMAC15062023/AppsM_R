<%@ Page Title="" Language="C#" MasterPageFile="~/RESDOT_Master_M.Master" AutoEventWireup="true" CodeBehind="RESDOT_MenuPage_M.aspx.cs" Inherits="RESDOT.RESDOT_MenuPage_M" %>
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <%--  <asp:Panel ID="Panel1" runat="server" BackImageUrl="Calender.gif"
         ...
         <%--      <asp:Menu ID="tabs1" runat="server" BackColor="Silver" Orientation="Horizontal" Width="100%" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" StaticSubMenuIndent="10px" BorderWidth="1px">
             <Items>
                 <asp:MenuItem Text="Master" Value="Masters">
                     <asp:MenuItem NavigateUrl="RESDOT_UserMaster.aspx" Text="UserMaster"
                         Value="Source Branch Add"></asp:MenuItem>
                 </asp:MenuItem>
                 </Items>
                     </asp:Menu>
             
             </asp:Panel>  //line comment on 05/03/2024
             --%> 
           ...
           <%-- <table style="font-size: 8pt; color: gray; font-family: Verdana; text-align: left">
                <tbody>
                 ...
                 <%--   <tr>
                    ...
                    </tr>--%> <%--already commented --%>
             <%--   </tbody>
            </table>
            &nbsp;--%><%-- comment on 05/03/2024>>--%>
            
         <div style="padding-left:20px" runat="server"> <%--div add on 05/03/2024--%>
